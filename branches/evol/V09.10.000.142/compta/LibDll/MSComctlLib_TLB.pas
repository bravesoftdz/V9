...
// ************************************************************************ //
// Bibl.Types     : C:\WINDOWS\system32\MSCOMCTL.OCX (1)
// IID\LCID       : {831FDD16-0C5C-11D2-A9FC-0000F8754DA1}\0
// Fichier d'aide : C:\WINDOWS\system32\cmctl198.chm
// DepndLst       : 
...
// *********************************************************************//
// Constantes pour enum BorderStyleConstants
type
...
// Constantes pour enum MousePointerConstants
type
...
// Constantes pour enum AppearanceConstants
type
...
// Constantes pour enum VB4AppearanceConstants
type
...
// Constantes pour enum ScrollingConstants
type
...
// Constantes pour enum OrientationConstants
type
...
// Constantes pour enum OLEDragConstants
type
...
// Constantes pour enum OLEDropConstants
type
...
// Constantes pour enum DragOverConstants
type
...
// Constantes pour enum ClipBoardConstants
type
...
// Constantes pour enum OLEDropEffectConstants
type
...
// Constantes pour enum TabWidthStyleConstants
type
...
// Constantes pour enum TabStyleConstants
type
...
// Constantes pour enum PlacementConstants
type
...
// Constantes pour enum TabSelStyleConstants
type
...
// Constantes pour enum ButtonStyleConstants
type
...
// Constantes pour enum ValueConstants
type
...
// Constantes pour enum ToolbarStyleConstants
type
...
// Constantes pour enum ToolbarTextAlignConstants
type
...
// Constantes pour enum SbarStyleConstants
type
...
// Constantes pour enum PanelAlignmentConstants
type
...
// Constantes pour enum PanelAutoSizeConstants
type
...
// Constantes pour enum PanelBevelConstants
type
...
// Constantes pour enum PanelStyleConstants
type
...
// Constantes pour enum LabelEditConstants
type
...
// Constantes pour enum TreeLineStyleConstants
type
...
// Constantes pour enum TreeStyleConstants
type
...
// Constantes pour enum TreeRelationshipConstants
type
...
// Constantes pour enum ListTextBackgroundConstants
type
...
// Constantes pour enum ListArrangeConstants
type
...
// Constantes pour enum ListPictureAlignmentConstants
type
...
// Constantes pour enum ListLabelEditConstants
type
...
// Constantes pour enum ListSortOrderConstants
type
...
// Constantes pour enum ListViewConstants
type
...
// Constantes pour enum ListColumnAlignmentConstants
type
...
// Constantes pour enum ListFindItemWhereConstants
type
...
// Constantes pour enum ListFindItemHowConstants
type
...
// Constantes pour enum ImageDrawConstants
type
...
// Constantes pour enum TickStyleConstants
type
...
// Constantes pour enum TextPositionConstants
type
...
// Constantes pour enum ImageComboStyleConstants
type
...
// *********************************************************************//
  ITabStrip = interface(IDispatch)
    ...
    procedure Set_Tabs(const ppTabs: ITabs); safecall;
    function  Get_Enabled: WordBool; safecall;
    procedure Set_Enabled(pbEnabled: WordBool); safecall;
    function  Get_Font: IFontDisp; safecall;
    procedure Set_Font(const ppFontDisp: IFontDisp); safecall;
    ...
    procedure Set_SelectedItem(const ppSelectedItem: ITab); safecall;
    procedure _Set_SelectedItem(var ppSelectedItem: OleVariant); safecall;
    ...
    property Tabs: ITabs read Get_Tabs write Set_Tabs;
    ...
    property ImageList: IDispatch read Get_ImageList write _Set_ImageList;
...
// *********************************************************************//
  ITabs = interface(IDispatch)
    ...
    procedure Set_ControlDefault(var pvIndex: OleVariant; const ppTab: ITab); safecall;
    function  Get_Item(var pvIndex: OleVariant): ITab; safecall;
    procedure Set_Item(var pvIndex: OleVariant; const ppTab: ITab); safecall;
    ...
    property ControlDefault[var pvIndex: OleVariant]: ITab read Get_ControlDefault write Set_ControlDefault; default;
    property Item[var pvIndex: OleVariant]: ITab read Get_Item write Set_Item;
  end;
...
// *********************************************************************//
  IToolbar = interface(IDispatch)
    ...
    procedure Set_Buttons(const ppButtons: IButtons); safecall;
    ...
    property Buttons: IButtons read Get_Buttons write Set_Buttons;
    ...
    property OLEDropMode: OLEDropConstants read Get_OLEDropMode write Set_OLEDropMode;
    property DisabledImageList: IDispatch read Get_DisabledImageList write _Set_DisabledImageList;
    property HotImageList: IDispatch read Get_HotImageList write _Set_HotImageList;
...
// *********************************************************************//
  IButtons = interface(IDispatch)
    ...
    procedure Set_ControlDefault(var Index: OleVariant; const ppButton: IButton); safecall;
    function  Get_Item(var Index: OleVariant): IButton; safecall;
    procedure Set_Item(var Index: OleVariant; const ppButton: IButton); safecall;
    ...
    function  _NewEnum: IDispatch; safecall;
    property Count: Smallint read Get_Count write Set_Count;
    property ControlDefault[var Index: OleVariant]: IButton read Get_ControlDefault write Set_ControlDefault; default;
    property Item[var Index: OleVariant]: IButton read Get_Item write Set_Item;
  end;
...
// *********************************************************************//
  IButton = interface(IDispatch)
    ...
    procedure Set_ButtonMenus(const ppButtonMenus: IButtonMenus); safecall;
    procedure Set_Tag(pvTag: OleVariant); safecall;
    property _ObjectDefault: WideString read Get__ObjectDefault write Set__ObjectDefault;
    property Caption: WideString read Get_Caption write Set_Caption;
    property Tag: OleVariant read Get_Tag write _Set_Tag;
    ...
    property ButtonMenus: IButtonMenus read Get_ButtonMenus write Set_ButtonMenus;
  end;
...
// *********************************************************************//
  IButtonMenus = interface(IDispatch)
    ...
    procedure Set_ControlDefault(var Index: OleVariant; const ppButtonMenu: IButtonMenu); safecall;
    function  Get_Item(var Index: OleVariant): IButtonMenu; safecall;
    procedure Set_Item(var Index: OleVariant; const ppButtonMenu: IButtonMenu); safecall;
    procedure Remove(var Index: OleVariant); safecall;
    procedure Clear; safecall;
    function  Add(var Index: OleVariant; var Key: OleVariant; var Text: OleVariant): IButtonMenu; safecall;
    function  _NewEnum: IDispatch; safecall;
    property Count: Smallint read Get_Count write Set_Count;
    property ControlDefault[var Index: OleVariant]: IButtonMenu read Get_ControlDefault write Set_ControlDefault; default;
    property Item[var Index: OleVariant]: IButtonMenu read Get_Item write Set_Item;
  end;
...
// *********************************************************************//
  IButtonMenu = interface(IDispatch)
    ...
    procedure Set_Parent(const ppParent: IButton); safecall;
    function  Get_Tag: OleVariant; safecall;
    procedure Set_Tag(pvTag: OleVariant); safecall;
    ...
    property Index: Smallint read Get_Index write Set_Index;
    property Key: WideString read Get_Key write Set_Key;
    property Parent: IButton read Get_Parent write Set_Parent;
...
// *********************************************************************//
  IStatusBar = interface(IDispatch)
    ...
    procedure Set_Panels(const ppPanels: IPanels); safecall;
    function  Get_MousePointer: MousePointerConstants; safecall;
    procedure Set_MousePointer(psMousePointer: MousePointerConstants); safecall;
    function  Get_MouseIcon: IPictureDisp; safecall;
    procedure _Set_MouseIcon(const ppMouseIcon: IPictureDisp); safecall;
    ...
    property Panels: IPanels read Get_Panels write Set_Panels;
    property MousePointer: MousePointerConstants read Get_MousePointer write Set_MousePointer;
    property MouseIcon: IPictureDisp read Get_MouseIcon write _Set_MouseIcon;
    property ShowTips: WordBool read Get_ShowTips write Set_ShowTips;
...
// *********************************************************************//
  IPanels = interface(IDispatch)
    ...
    procedure Set_ControlDefault(var Index: OleVariant; const ppPanel: IPanel); safecall;
    ...
    procedure Set_Item(var Index: OleVariant; const ppPanel: IPanel); safecall;
    procedure Remove(var Index: OleVariant); safecall;
    function  _NewEnum: IDispatch; safecall;
    property Count: Smallint read Get_Count write Set_Count;
    property ControlDefault[var Index: OleVariant]: IPanel read Get_ControlDefault write Set_ControlDefault; default;
    property Item[var Index: OleVariant]: IPanel read Get_Item write Set_Item;
  end;
...
// *********************************************************************//
  ITreeView = interface(IDispatch)
    ...
    procedure Set_DropHighlight(const ppNode: INode); safecall;
    procedure _Set_DropHighlight(var ppNode: OleVariant); safecall;
    ...
    procedure Set_Nodes(const ppNode: INodes); safecall;
    ...
    procedure Set_SelectedItem(const ppNode: INode); safecall;
    procedure _Set_SelectedItem(var ppNode: OleVariant); safecall;
    ...
    property MousePointer: MousePointerConstants read Get_MousePointer write Set_MousePointer;
    property MouseIcon: IPictureDisp read Get_MouseIcon write _Set_MouseIcon;
    property Nodes: INodes read Get_Nodes write Set_Nodes;
...
// *********************************************************************//
  INode = interface(IDispatch)
    ...
    procedure Set_Child(const ppChild: INode); safecall;
    ...
    procedure Set_FirstSibling(const ppFirstSibling: INode); safecall;
    ...
    procedure Set_LastSibling(const ppLastSibling: INode); safecall;
    function  Get_Next: INode; safecall;
    procedure Set_Next(const ppNext: INode); safecall;
    function  Get_Parent: INode; safecall;
    procedure Set_Parent(const ppParent: INode); safecall;
    function  Get_Previous: INode; safecall;
    procedure Set_Previous(const ppPrevious: INode); safecall;
    function  Get_Root: INode; safecall;
    procedure Set_Root(const ppRoot: INode); safecall;
    function  Get_Selected: WordBool; safecall;
    procedure Set_Selected(pbSelected: WordBool); safecall;
    ...
    procedure Set_Tag(pvTag: OleVariant); safecall;
    property _ObjectDefault: WideString read Get__ObjectDefault write Set__ObjectDefault;
    property Child: INode read Get_Child write Set_Child;
    ...
    property FirstSibling: INode read Get_FirstSibling write Set_FirstSibling;
    property FullPath: WideString read Get_FullPath write Set_FullPath;
    property Image: OleVariant read Get_Image write Set_Image;
    property Index: Smallint read Get_Index write Set_Index;
    property Key: WideString read Get_Key write Set_Key;
    property LastSibling: INode read Get_LastSibling write Set_LastSibling;
    property Next: INode read Get_Next write Set_Next;
    property Parent: INode read Get_Parent write Set_Parent;
    property Previous: INode read Get_Previous write Set_Previous;
    property Root: INode read Get_Root write Set_Root;
    property Selected: WordBool read Get_Selected write Set_Selected;
...
// *********************************************************************//
  IListView = interface(IDispatch)
    ...
    procedure Set_DropHighlight(const ppIListItem: IListItem); safecall;
    procedure _Set_DropHighlight(var ppIListItem: OleVariant); safecall;
    ...
    procedure Set_SelectedItem(const ppListItem: IListItem); safecall;
    procedure _Set_SelectedItem(var ppListItem: OleVariant); safecall;
    ...
    property HideSelection: WordBool read Get_HideSelection write Set_HideSelection;
    property Icons: IDispatch read Get_Icons write _Set_Icons;
    ...
    property MousePointer: MousePointerConstants read Get_MousePointer write Set_MousePointer;
    property MultiSelect: WordBool read Get_MultiSelect write Set_MultiSelect;
    property SmallIcons: IDispatch read Get_SmallIcons write _Set_SmallIcons;
    property Sorted: WordBool read Get_Sorted write Set_Sorted;
    ...
    property ColumnHeaderIcons: IDispatch read Get_ColumnHeaderIcons write _Set_ColumnHeaderIcons;
...
// *********************************************************************//
  IImageList = interface(IDispatch)
    ...
    procedure Set_ListImages(const ppListImages: IImages); safecall;
    ...
    property ListImages: IImages read Get_ListImages write Set_ListImages;
...
// *********************************************************************//
  IImages = interface(IDispatch)
    ...
    procedure Set_ControlDefault(var Index: OleVariant; const ppListImage: IImage); safecall;
    ...
    procedure Set_Item(var Index: OleVariant; const Item: IImage); safecall;
    procedure Remove(var Index: OleVariant); safecall;
    function  _NewEnum: IDispatch; safecall;
    property Count: Smallint read Get_Count write Set_Count;
    property ControlDefault[var Index: OleVariant]: IImage read Get_ControlDefault write Set_ControlDefault; default;
    property Item[var Index: OleVariant]: IImage read Get_Item write Set_Item;
  end;
...
// *********************************************************************//
  IImageCombo = interface(IDispatch)
    ...
    procedure Set_ComboItems(const ppComboItems: IComboItems); safecall;
    ...
    procedure Set_SelectedItem(const ppIComboItem: IComboItem); safecall;
    procedure _Set_SelectedItem(var ppIComboItem: OleVariant); safecall;
    function  Get_SelLength: Integer; safecall;
    procedure Set_SelLength(plSelLength: Integer); safecall;
    function  Get_SelStart: Integer; safecall;
    procedure Set_SelStart(plSelStart: Integer); safecall;
    ...
    property ImageList: IDispatch read Get_ImageList write _Set_ImageList;
    property Indentation: Smallint read Get_Indentation write Set_Indentation;
    property ComboItems: IComboItems read Get_ComboItems write Set_ComboItems;
...
// *********************************************************************//
// La classe CoDataObject fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IVBDataObject exposée             
// pas la CoClass DataObject. Les fonctions sont destinées à être utilisées par            
...
// *********************************************************************//
// La classe CoDataObjectFiles fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IVBDataObjectFiles exposée             
// pas la CoClass DataObjectFiles. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoTabs fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut ITabs exposée             
// pas la CoClass Tabs. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoTabs = class
...
// *********************************************************************//
// La classe CoTab fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut ITab exposée             
// pas la CoClass Tab. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoTab = class
...
// *********************************************************************//
// La classe CoButtons fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IButtons exposée             
// pas la CoClass Buttons. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoButtons = class
...
// créer des instances de l'interface par défaut IButton exposée             
// pas la CoClass Button. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoButton = class
...
// *********************************************************************//
// La classe CoButtonMenus fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IButtonMenus exposée             
// pas la CoClass ButtonMenus. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoButtonMenus = class
...
// *********************************************************************//
// La classe CoButtonMenu fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IButtonMenu exposée             
// pas la CoClass ButtonMenu. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoButtonMenu = class
...
// *********************************************************************//
// La classe CoPanels fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IPanels exposée             
// pas la CoClass Panels. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoPanels = class
...
// créer des instances de l'interface par défaut IPanel exposée             
// pas la CoClass Panel. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoPanel = class
...
// *********************************************************************//
// La classe CoNodes fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut INodes exposée             
// pas la CoClass Nodes. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoNodes = class
...
// *********************************************************************//
// La classe CoNode fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut INode exposée             
// pas la CoClass Node. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoNode = class
...
// *********************************************************************//
// La classe CoListItems fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IListItems exposée             
// pas la CoClass ListItems. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoListItems = class
...
// *********************************************************************//
// La classe CoListItem fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IListItem exposée             
// pas la CoClass ListItem. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoListItem = class
...
// *********************************************************************//
// La classe CoColumnHeaders fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IColumnHeaders exposée             
// pas la CoClass ColumnHeaders. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoColumnHeader fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IColumnHeader exposée             
// pas la CoClass ColumnHeader. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoListSubItems fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IListSubItems exposée             
// pas la CoClass ListSubItems. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoListSubItem fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IListSubItem exposée             
// pas la CoClass ListSubItem. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoListSubItem = class
...
// *********************************************************************//
// La classe CoListImages fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IImages exposée             
// pas la CoClass ListImages. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoListImages = class
...
// *********************************************************************//
// La classe CoListImage fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IImage exposée             
// pas la CoClass ListImage. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoListImage = class
...
// *********************************************************************//
// La classe CoControls fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IControls exposée             
// pas la CoClass Controls. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoControls = class
...
// *********************************************************************//
// La classe CoComboItem fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IComboItem exposée             
// pas la CoClass ComboItem. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoComboItem = class
...
// *********************************************************************//
// La classe CoComboItems fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IComboItems exposée             
// pas la CoClass ComboItems. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoComboItems = class
