...
procedure BalVentileTP ;
procedure BalVentileZoomTP(Crit : TCritEdt) ;

type
  TFQRBalVenTP = class(TFQR)
    HLabel3: THLabel;
    FTypeGL: TRadioGroup;
    HLabel9: THLabel;
...
Function TFQRBalVenTP.QuoiCpt(i : Integer) : String ;
BEGIN
...
Procedure TFQRBalVenTP.BalVentZoom(Quoi : String) ;
Var Lp,i: Integer ;
BEGIN
...
BEGIN
PP:=FindInsidePanel ;
QR:=TFQRBalVenTP.Create(Application) ;
...
try
 QR.QRP.QRPrinter.OnSynZoom:=QR.BalVentZoom ;
 QR.InitType (nbAux,neGlV,msRien,'QRBALVENTP','',FALSE,TRUE,FALSE,Edition) ;
 finally
 QR.Free ;
 end ;
Screen.Cursor:=SyncrDefault ;
...
procedure TFQRBalVenTP.FinirPrint ;
Var SOlde : Double ;
BEGIN
Inherited ;
QEcr.Close ;
...
procedure TFQRBalVenTP.InitDivers ;
BEGIN
Inherited ;
...
procedure TFQRBalVenTP.GenereSQL ;
...
procedure TFQRBalVenTP.GenereSQLSub ;
{ Construction de la requête SQL en fonction du multicritère }
BEGIN
Inherited ;
...
procedure TFQRBalVenTP.RenseigneCritere ;
...
procedure TFQRBalVenTP.ChoixEdition ;
BEGIN
Inherited ;
...
procedure TFQRBalVenTP.FColl1Change(Sender: TObject);
...
procedure TFQRBalVenTP.RecupCritEdt ;
...
function TFQRBalVenTP.CritOk : Boolean ;
BEGIN
...
Procedure TFQRBalVenTP.Calculs(var Report1,Report2 : TReport; i : integer; Bool1, Bool2 : Boolean ) ;
...
procedure TFQRBalVenTP.SaisieDates ;
Var i : byte ;
...
procedure TFQRBalVenTP.FormShow(Sender: TObject);
begin
//HelpContext:=7556010 ;
...
procedure TFQRBalVenTP.BSubDetailBeforePrint(var PrintBand: Boolean;  var Quoi: string);
var MReport : TabTRep ;
    OkCalcul : Boolean ;
begin
Inherited ;
...
procedure TFQRBalVenTP.BFinEtatBeforePrint(var PrintBand: Boolean;  var Quoi: string);
Var LeTot : TabTot ;
begin
  inherited;
(*
...
procedure TFQRBalVenTP.BMdpBeforePrint(var PrintBand: Boolean;  var Quoi: string);
begin
  inherited;
...
procedure TFQRBalVenTP.BFCompteAuxBeforePrint(var PrintBand: Boolean;  var Quoi: string);
Var
...
procedure TFQRBalVenTP.BDetailBeforePrint(var PrintBand: Boolean;  var Quoi: string);
begin
  inherited;
...
procedure TFQRBalVenTP.FTypeGLClick(Sender: TObject);
begin
  inherited;
If FChoixEcart.ItemIndex=1 then SaisieDates ;
end;

procedure TFQRBalVenTP.FDateCompta1Exit(Sender: TObject);
begin
  inherited;
If FChoixEcart.ItemIndex=1 then SaisieDates ;
end;

procedure TFQRBalVenTP.FChoixEcartClick(Sender: TObject);
begin
  inherited;
...
procedure TFQRBalVenTP.FP5Exit(Sender: TObject);
Var St : String ;
    A  : Char   ;
begin
  inherited;
...
procedure TFQRBalVenTP.tabSupEnter(Sender: TObject);
begin
  inherited;
FPeriodicite.SetFocus ;
end;

procedure TFQRBalVenTP.FTypeParClick(Sender: TObject);
begin
  inherited;
...
procedure TFQRBalVenTP.FPeriodiciteChange(Sender: TObject);
Var i : Integer ;
    TabD : TTabDate8 ;
begin
  inherited;
...
procedure TFQRBalVenTP.TOPREPORTBeforePrint(var PrintBand: Boolean;  var Quoi: string);
begin
  inherited;
...
procedure TFQRBalVenTP.BOTTOMREPORTBeforePrint(var PrintBand: Boolean;  var Quoi: string);
var MReport : TabTRep ;
    TB : TabTot ;
    i : Integer ;
begin
...
procedure TFQRBalVenTP.QEcrAfterOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TFQRBalVenTP.FCpte1Change(Sender: TObject);
//Var AvecJokerS : Boolean ;
begin
  inherited;
...
procedure TFQRBalVenTP.FNatureCptChange(Sender: TObject);
begin
  inherited;
...
procedure TFQRBalVenTP.BNouvRechClick(Sender: TObject);
begin
  inherited;
...
procedure TFQRBalVenTP.DLRuptNeedData(var MoreData: Boolean);
var TotRupt          : Array[0..13] of Double ;
...
procedure TFQRBalVenTP.BRuptBeforePrint(var PrintBand: Boolean; var Quoi: string);
begin
  inherited;
PrintBand:=(CritEdt.Rupture<>rRien) ;
end;

procedure TFQRBalVenTP.QAfterOpen(DataSet: TDataSet);
begin
  inherited;
If (CritEdt.GlV.TypePar=0) Then
  BEGIN
...
procedure TFQRBalVenTP.FSansRuptClick(Sender: TObject);
begin
  inherited;
...
procedure TFQRBalVenTP.FRupturesClick(Sender: TObject);
begin
  inherited;
...
procedure TFQRBalVenTP.BFCompteAuxAfterPrint(BandPrinted: Boolean);
begin
  inherited;
BFCompteAux.ForceNewPage:=FALSE ;
end;

procedure TFQRBalVenTP.BPIEDTPBeforePrint(var PrintBand: Boolean;  var Quoi: String);
begin
  inherited;
...
procedure TFQRBalVenTP.BENTETETPBeforePrint(var PrintBand: Boolean; var Quoi: String);
Var St : String ;
begin
  inherited;
