...
uses Sysutils,Classes,HmsgBox,StrUtils,ed_tools,HCtrls,
     {$IFDEF EAGLCLIENT}
     UTOB,
     {$ELSE}
     {$IFNDEF DBXPRESS}dbtables{BDE},{$ELSE}uDbxDataSet,{$ENDIF}
     {$ENDIF}
     CstCommun,Uutil,BPBasic,BPFctSession,BPFctArbre,UDatamem,BPUtil;
...
begin
  ...
  Case ContextBP of
    0,1 : begin
          ReqSql := AnsiReplaceText(ReqSql,'[PREFIXE]','');
    ...
    3 : begin
          ...
          ReqValAffTree(codeSession,'',0,NbValAff,codeChpsSum,_tmp_,codeTable,_tmp_);
