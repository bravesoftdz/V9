...
Function CreerLignesTiers ( TOBEcr,TOBPiece,TOBEches,TOBTiers,TOBAcomptes,TOBpieceRG,TOBBasesRG,TOBPieceTrait,TOBPorcs : TOB; DEV : RDevise; var MM : RMVT ) : T_RetCpta ;
Var TOBTTC,TOBG,TOBH : TOB ;
    i,cpt,NumE,NumL : integer ;
    GColl,ModePaie : String ;
    OkVent : boolean ;
...
begin
  ...
  TRY
    ...
    if MM1.Jal <> '' then
    begin
      SQl := 'SELECT ECRITURE.*, 0 AS MTRESTITUE, 0 AS MTRESITUEDEV '+
             'FROM ECRITURE '+
             'WHERE  '+
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            TCDEV := TCDEV + TTX.GetDouble('MTRESTITUE');
          end;
        end;
...
Function PasseEnCompta ( TOBPiece,TOBOuvrages,TOBOuvragesP,TOBBases,TOBBasesST,TOBBasesCharge,TOBEches,TOBpieceTrait,TOBAFFInterv,TOBTiers,TOBArticles,TOBCpta,TOBAcomptes,TOBPorcs,TOBPieceRG,TOBBasesRG,TOBAnaP,TOBAnaS,TOBPieceinterv : TOB ; NbDec : integer ; OldEcr : RMVT ; DEV : RDevise; NewPiece : Boolean) : T_RetCpta ;
...
begin
  {Lignes de Tiers}
  Result:=CreerLignesTiers(TOBEcr,TOBPiece,TOBEches,TOBTiers,TOBAcomptes,TOBPieceRg,TOBbasesRG,TOBpieceTrait,TOBPorcs,DEV, MM) ;
  {Lignes HT}
...
Res:=PasseEnCompta(TOBPieceCpta,TOBOuvrages,TOBOuvragesPCpta,TOBBasesCpta,TOBBasesCptaST,TOBBasesCharges,TOBEchesCpta,TOBPieceTrait,TOBAFFInterv,TOBTiersCpta,TOBArticles,TOBCpta,TOBAcomptesCpta ,TOBPorcsCpta,TOBPieceRGCpta,TOBBaseRGCpta ,TOBanaP,TOBAnaS,TOBPieceinterv,DEV.Decimale,OldEcr,DEV,NewPiece) ;
