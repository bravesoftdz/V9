...
// Fichier généré le 01/09/2000 15:51:46 depuis la bibliothèque de types ci-dessous.
...
// Erreurs :
//   Remarque : paramètre 'Label' dans IMSMQQuery.LookupQueue changé en 'Label_'
//   Conseil : Membre 'Label' de 'IMSMQQueueInfo' modifié en 'Label_'
//   Conseil : Membre 'Class' de 'IMSMQMessage' modifié en 'Class_'
//   Conseil : Membre 'Label' de 'IMSMQMessage' modifié en 'Label_'
//   Conseil : Membre 'Label' de 'IMSMQQueueInfo2' modifié en 'Label_'
//   Conseil : Membre 'Class' de 'IMSMQMessage2' modifié en 'Class_'
//   Conseil : Membre 'Label' de 'IMSMQMessage2' modifié en 'Label_'
//   Remarque : paramètre 'Label' dans IMSMQQuery2.LookupQueue changé en 'Label_'
//   Erreur à la création du bitmap de palette de (TMSMQQuery) : Le serveur C:\WINNT\System32\MQOA.DLL ne contient pas d'icones
//   Erreur à la création du bitmap de palette de (TMSMQMessage) : Le serveur C:\WINNT\System32\MQOA.DLL ne contient pas d'icones
//   Erreur à la création du bitmap de palette de (TMSMQQueue) : Le serveur C:\WINNT\System32\MQOA.DLL ne contient pas d'icones
//   Erreur à la création du bitmap de palette de (TMSMQEvent) : Le serveur C:\WINNT\System32\MQOA.DLL ne contient pas d'icones
//   Erreur à la création du bitmap de palette de (TMSMQQueueInfo) : Le serveur C:\WINNT\System32\MQOA.DLL ne contient pas d'icones
//   Erreur à la création du bitmap de palette de (TMSMQQueueInfos) : Le serveur C:\WINNT\System32\MQOA.DLL ne contient pas d'icones
//   Erreur à la création du bitmap de palette de (TMSMQTransaction) : Le serveur C:\WINNT\System32\MQOA.DLL ne contient pas d'icones
//   Erreur à la création du bitmap de palette de (TMSMQCoordinatedTransactionDispenser) : Le serveur C:\WINNT\System32\MQOA.DLL ne contient pas d'icones
//   Erreur à la création du bitmap de palette de (TMSMQTransactionDispenser) : Le serveur C:\WINNT\System32\MQOA.DLL ne contient pas d'icones
//   Erreur à la création du bitmap de palette de (TMSMQApplication) : Le serveur C:\WINNT\System32\MQOA.DLL ne contient pas d'icones
// ************************************************************************ //
...
// *********************************************************************//
// La classe CoMSMQQuery fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMSMQQuery2 exposée             
// pas la CoClass MSMQQuery. Les fonctions sont destinées à être utilisées par            
...
// Chaîne d'aide        : Objet proposant des options de recherche dans Message Queuing utilisées pour rechercher des files d'attente publiques.
// Interface par défaut : IMSMQQuery2
// DISP Int. Déf. ?     : No
...
// *********************************************************************//
// La classe CoMSMQMessage fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMSMQMessage2 exposée             
// pas la CoClass MSMQMessage. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoMSMQMessage = class
...
// Chaîne d'aide        : Objet décrivant un message Message Queuing. Un message peut être créé et envoyé à une file ou extrait d'une file.
// Interface par défaut : IMSMQMessage2
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoMSMQQueue fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMSMQQueue2 exposée             
// pas la CoClass MSMQQueue. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoMSMQQueue = class
...
// Chaîne d'aide        : Objet décrivant une file ouverte qui prend en charge l'extraction d'un message. Obtenu en appelant la méthode MSMQQueueInfo.Open.
// Interface par défaut : IMSMQQueue2
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoMSMQEvent fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMSMQEvent2 exposée             
// pas la CoClass MSMQEvent. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoMSMQEvent = class
...
// Chaîne d'aide        : Objet décrivant des événements asynchrones Message Queuing sortants. Utilisé pour avertir de l'arrivée d'un message asynchrone.
// Interface par défaut : IMSMQEvent2
// DISP Int. Déf. ?     : No
// Interface événements : _DMSMQEventEvents
// TypeFlags            : (2) CanCreate
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
...
// *********************************************************************//
// La classe CoMSMQQueueInfo fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMSMQQueueInfo2 exposée             
// pas la CoClass MSMQQueueInfo. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : Objet décrivant une file d'attente. Utilisé pour créer, supprimer et ouvrir des files.
// Interface par défaut : IMSMQQueueInfo2
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoMSMQQueueInfos fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMSMQQueueInfos2 exposée             
// pas la CoClass MSMQQueueInfos. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : Objet décrivant une série de files d'attente créées à l'aide de MSMQQuery.LookupQueue.
// Interface par défaut : IMSMQQueueInfos2
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoMSMQTransaction fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMSMQTransaction2 exposée             
// pas la CoClass MSMQTransaction. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : Objet implémentant l'objet de transaction MSMQ. Prend en charge les méthodes ITransaction standard Commit et Abort.
// Interface par défaut : IMSMQTransaction2
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoMSMQCoordinatedTransactionDispenser fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMSMQCoordinatedTransactionDispenser2 exposée             
// pas la CoClass MSMQCoordinatedTransactionDispenser. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : Objet implémentant le distributeur de transactions de DTC. Prend en charge la création de nouvelles transactions DTC.
// Interface par défaut : IMSMQCoordinatedTransactionDispenser2
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoMSMQTransactionDispenser fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMSMQTransactionDispenser2 exposée             
// pas la CoClass MSMQTransactionDispenser. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : Objet implémentant le distributeur de transactions de MSMQ. Prend en charge la création de nouvelles transactions MSMQ internes.
// Interface par défaut : IMSMQTransactionDispenser2
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoMSMQApplication fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMSMQApplication2 exposée             
// pas la CoClass MSMQApplication. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClass exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : Objet implémentant l'objet de l'application MSMQ. Propose une fonctionnalité globale.
// Interface par défaut : IMSMQApplication2
// DISP Int. Déf. ?     : No
// Interface événements : 
