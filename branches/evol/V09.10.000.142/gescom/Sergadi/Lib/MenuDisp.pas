...
(*
  V_PGI.UserLogin  := 'CEGID';
  V_PGI.PassWord   := CryptageSt('CEGID');
...
*)
      ...
      if connect then TraiteLaSaisie;
...
begin
  ...
  case Num of
    ...
    16 :;
    324001 :
        LanceSaisieSERGADI('CRE');
    324002 :
        LanceSaisieSERGADI('VAL');
...
initialization
  ...
  TitreHalley := 'Spécifique SERGADI';
...
V_PGI.NumBuild:='000.053';
V_PGI.CodeProduit:='034' ;
V_PGI.DateVersion:=EncodeDate(2013,11,06);
