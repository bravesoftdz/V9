...
type
  ...
  RInfoLigne = record
	...
	TRecalculPiece = class
      ...
      TOBArticles,TOBTiers,TOBPieceRG,TOBPieceRG_O,TOBBasesRG,TOBBases,TOBBasesL,TOBAffaireInterv : TOB;
      TOBaffaire : TOB;
      TOBPieceTrait : TOB;
...
uses factcomm,FactOuvrage,FactUtil,FactCalc,
     ...
     FactureBTP,ParamSoc,UtilArticle,FactRg,factCpta
     ;
...
//    	AjouteLignesVirtuellesOuv ( TOBPiece,TOBOuvrages ,TOBArticles,nil,TOBTiers,nil,nil,nil,DEV) ;
    ...
    TOBBases.ClearDetail;
    TOBBasesL.ClearDetail;
    CalculFacture( TOBaffaire,TOBPiece, TOBPieceTrait,TOBSSTRAIT,TOBouvrages, TOBOuvragesP, TOBBases, TOBBasesL,TOBTiers, TOBArticles, TOBPorcs, TOBPieceRG, TOBBasesRG, DEV, false, taModif,false,-1,false,true);
...
//  if not TOBBasesRG.InsertDB(nil,true) then BEGIN V_PGI.Ioerror := OeSaisie; Exit; END;
  ...
  begin
    if not PassationComptable( TOBPiece,TOBOUvrages,TOBOuvragesP, TOBBases,TOBBasesL, TOBEches,TOBPieceTrait,
                               ...
                               TOBPIECERG, TOBBASESRG, TOBanaP,TOBanaS,TOBSSTRAIT, DEV, OldEcr,
