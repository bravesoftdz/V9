object FKillLot: TFKillLot
  Left = 301
  Top = 202
  Width = 269
  Height = 156
  BorderIcons = []
  Caption = 'Destruction d'#39'un lot'
  Color = clBtnFace
  ...
  object HM: THMsgBox
    ...
    Mess.Strings = (
      ...
      '1;?Caption?;Ce lot n'#39'existe pas.;W;O;O;O;'
      '2;?Caption?;Confirmez-vous le traitement?;E;YN;N;N;'
      '3;?Caption?;Traitement impossible : ce lot est utilis'#233';W;O;O;O;')
    Left = 52
    Top = 100
  end
end
