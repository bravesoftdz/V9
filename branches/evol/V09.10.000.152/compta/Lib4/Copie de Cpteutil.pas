...
//                                      FSpeedActif : Boolean = FALSE ; FHisto : Boolean = FALSE ; FFiltreSup : String = '') ;
                   ...
                   Procedure InitAnalyseCompte(C11,C12,C21,C22 : String) ;
                   end ;


Function PrepareTotCpt(fb : TFichierBase ; SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean ; Multiple : TTypeCalc) : TQuery ;
procedure ExecuteTotCpt(Var Q : TQuery ; Cpt : String17 ; Date1,Date2 : TDateTime ; Devise,Etab,Exo : String3 ;
                        ...
                        fb : tfichierbase ; SetType : SetttTypePiece ; Multiple : TTypeCalc ; DeviseEnPivot : Boolean) ;

Function PrepareTotCptSolde(SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean) : TQuery ;
procedure ExecuteTotCptSolde(Var Q : TQuery ; Cpt1 : String17 ; Date1,Date2 : TDateTime ; Devise,Etab,Exo : String3 ;
                             ...
                             Dec,DecE : Integer ; MonnaieOpposee : Boolean ; DeviseEnPivot : Boolean ; SetTyp : SetttTypePiece) ;

Function PrepareTotJal(CodCpt:String3 ; SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean) : TQuery ;
...
Function PrepareTotCptJointure(fb : TFichierBase ; SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean ;
                               PrefixeJointure,ChampJointure,NomChampJointure,ValeurChampJointure : String) : TQuery ;
...
Function  FabricSpeedReq1 ( fb : TFichierBase ; SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean ; Multiple : TTypeCalc ; CptIn,CptOut : String ; DD1,DD2 : tDateTime; bAnalyseCompte: Boolean ;
                            Devise,Etab,Exo : String) : String ;
Function  DemandeSpeedCpt1(Cpt : String) : TabTot ;
Function  SpeedActif(SurQuelfb : tFichierBase ; SurQuelExo,SurQuelEtab,SurQuelleDevise : String ; QurQuelleDate1,SurQuelleDate2 : tDateTime) : Boolean ;
...
Function FabricReqCpt1 ( fb : TFichierBase ; SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean ; Multiple : TTypeCalc ;
                         ...
                         Cpte : String ; Date1,Date2 : TDateTime ; Etab,Devise,Exo : String ; VCS : Variant) : TQuery ;
Var Q   : TQuery ;
    StCalc,StD : String ;
    SUM_Montant : String ;
    P : String[2] ;
...
Q:=OpenSQL(SQL,TRUE) ;
{$ELSE}
If not EstSpecif('51185') Then Q:=OpenSQL(SQL,TRUE)
...
Function FabricReqHisto1 ( fb : TFichierBase ; SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean ; Multiple : TTypeCalc;
                           BalSit : string ; Cpte : String ; FiltreSup : String) : TQuery ;
Var Q   : TQuery ;
    StCalc,SQL : String ;
    SUM_Montant : String ;
//    P : String[2] ;
...
If not EstSpecif('51185') Then
  BEGIN
  Q:=FabricReqCpt1(fb,SetType,Devise<>'',Etab<>'',Exo<>'',DeviseEnPivot,Multiple,'','',Cpt,Date1,Date2,Etab,Devise,Exo,NULL) ;
...
Function FabricReqCpt2 ( fb,fb2 : TFichierBase ; SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean ; Multiple : TTypeCalc ;
                         FiltreSup,ChampSup : String ;
                         Cpte1,Cpte2 : String ; Date1,Date2 : TDateTime ; Etab,Devise,Exo : String ; VCS : Variant) : TQuery ;
Var Q   : TQuery ;
    StCalc,SQL : String ;
    SUM_Montant : String ;
    P : String[2] ;
...
Function FabricReqCpt3 ( SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean ;
                         Cpte : String ; Date1,Date2 : TDateTime ; Etab,Devise,Exo : String) : TQuery ;
Var Q   : TQuery ;
    StCalc,SQL : String ;
    SUM_Montant : String ;
    DEV : String3 ;
...
BEGIN
Result:=NIL ;
If  EstSpecif('51185') Then Result:=FabricReqCpt3(SetTyp,FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot,'',iDate1900,iDate1900,'','','') ;
END ;
...
If not EstSpecif('51185') Then
  BEGIN
  Q:=FabricReqCpt3(SetTyp,Devise<>'',etab<>'',exo<>'',DeviseEnPivot,Cpt1,Date1,Date2,Etab,Devise,Exo) ;
...
BEGIN
Result:=Nil ;
If  EstSpecif('51185') Then Result:=FabricReqJal(CodCpt,SetTyp,FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot,'',iDate1900,iDate1900,'','','') ;
END ;
...
Function FabricReqCpt5 ( fb : TFichierBase ; SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean ;
                         PrefixeJointure,ChampJointure,NomChampJointure,ValeurChampJointure : String ;
                         Date1,Date2 : TDateTime ; Etab,Devise,Exo : String) : TQuery ;
Var Q   : TQuery ;
    StCalc,SQL : String ;
    SUM_Montant : String ;
    P : String[2] ;
...
Function FabricReqCpt2Bud ( fb,fb2 : TFichierBase ; SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean ; Multiple : TTypeCalc ;
                            Cpte1,Cpte2 : String ; Date1,Date2 : TDateTime ; Etab,Devise,Exo : String) : TQuery ;
Var Q   : TQuery ;
    StCalc,SQL : String ;
    SUM_Montant : String ;
BEGIN
...
If FSpeedActif Then
  ...
  if (VH^.SpeedObj<>nil) and (VH^.bSpeedFree) then
    begin TZSpeed(VH^.SpeedObj).Free ; VH^.SpeedObj:=nil ; VH^.bSpeedFree:=FALSE ; end ;
  if (VH^.SpeedObj=nil) then VH^.SpeedObj:=TZSpeed.Create(Application) ;
  Exit ;
  END ;
...
If  EstSpecif('51185') Then
  ...
  //         If Histo Then Q:=FabricReqHisto1(fb1,SetTyp,FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot,Multiple)
           ...
           begin
            Inc(VH^.NbGC) ;
            QBalSit:=FabricReqHisto1(fb1,SetTyp,FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot,Multiple,FBalSit,'','');
           end;
...
BEGIN
if QBalSit <> nil then begin QBalSit.Close; Dec(VH^.NbGC) ; QBalSit.Free; END;   // CA - 21/11/2001
If Q<>NIL Then BEGIN Q.Close ; Dec(VH^.NbGC) ; Q.Free ; END ; Inherited Destroy ;
END ;

Procedure TGCalculCum.InitAnalyseCompte(C11,C12,C21,C22 : String) ;
BEGIN
If Not PrepCalc.SpeedActif Then Exit ;
if (VH^.SpeedObj<>nil) then TZSpeed(VH^.SpeedObj).InitAnalyseCompte(C11,C12) ;
END ;
...
If PrepCalc.SpeedActif Then
  BEGIN
  if (VH^.SpeedObj<>nil) then
    begin
  //    TZSpeed(VH^.SpeedObj).SetParams(Params) ;
    ExecCalc.totCpt:=TZSpeed(VH^.SpeedObj).GetCumul(ExecCalc.Cpt1, '', ExecCalc.Params, PrepCalc.Decimale,'','TO') ;
//    Result:=TZSpeed(VH^.SpeedObj).GetResult(Total, SetTyp, AvecAno, '') ;
...
If EstSpecif('51187') Then
  ...
  If UseTC And (VH^.TobCum<>NIL) Then
    ...
    ExecCalc.totCpt:=DonneCumul(VH^.TOBCUM,ExecCalc.Cpt1,ExecCalc.Cpt2,Multiple,PrepCalc.Fb1,PrepCalc.Fb2,PrepCalc.SetTyp,
                                ...
                                ExecCalc.Date1,ExecCalc.Date2,PrepCalc.ChampSup,ExecCalc.ValChampSup,PrepCalc.FiltreSup) ;
    If ExecCalc.SommeTout Then
       BEGIN
       Sommation(ExecCalc.TotCpt,FALSE) ; Sommation(ExecCalc.TotCptEuro,FALSE) ;
       END ;
...
Deux : BEGIN
       ...
       If not EstSpecif('51185') Then
         ...
         Q:=FabricReqCpt2(prepCalc.fb1,prepCalc.fb2,prepCalc.SetTyp,prepCalc.FiltreDev,prepCalc.FiltreEtab,prepCalc.FiltreExo,prepCalc.DeviseEnPivot,Multiple,prepCalc.FiltreSup,prepCalc.ChampSup,
                          ExecCalc.Cpt1,ExecCalc.Cpt2,D21,D22,ExecCalc.Etab,ExecCalc.Devise,ExecCalc.Exo,ExecCalc.ValChampSup) ;
  ...
  Un : BEGIN
       ...
       If ExecCalc.BalSit Then  // CA - 21/11/2001 : si indicateur BalSit, on calcule sur la balance
          ...
          If not EstSpecif('51185') Then
            BEGIN
            QBalSit:=FabricReqHisto1(PrepCalc.fb1,PrepCalc.SetTyp,PrepCalc.FiltreDev,PrepCalc.FiltreEtab,PrepCalc.FiltreExo,PrepCalc.DeviseEnPivot,Multiple,PrepCalc.BalSit,ExecCalc.Cpt1,prepCalc.FiltreSup);
...
//            CalculHisto(QBalSit,D21,D22,ExecCalc.Cpt1,ExecCalc.Devise,ExecCalc.Etab,ExecCalc.Exo,ExecCalc.TotCpt,ExecCalc.TotCptEuro,PrepCalc.Decimale,PrepCalc.DecimaleEuro) ;
          ...
          If not EstSpecif('51185') Then
            ...
            Q:=FabricReqCpt1(prepCalc.fb1,prepCalc.SetTyp,prepCalc.FiltreDev,prepCalc.FiltreEtab,prepCalc.FiltreExo,prepCalc.DeviseEnPivot,Multiple,prepCalc.FiltreSup,prepCalc.ChampSup,
                             ExecCalc.Cpt1,D21,D22,ExecCalc.Etab,ExecCalc.Devise,ExecCalc.Exo,ExecCalc.ValChampSup) ;
  ...
  UnBud : BEGIN
          ...
          If not EstSpecif('51185') Then
            ...
            Q:=FabricReqCpt1Bud(prepCalc.fb1,prepCalc.SetTyp,prepCalc.FiltreDev,prepCalc.FiltreEtab,prepCalc.FiltreExo,prepCalc.DeviseEnPivot,Multiple,
                                ExecCalc.Cpt1,D21,D22,ExecCalc.Etab,ExecCalc.Devise,ExecCalc.Exo) ;
            PositionneTotaux(Q,ExecCalc.TotCpt,ExecCalc.TotCptEuro,PrepCalc.Decimale,PrepCalc.DecimaleEuro) ;
            Ferme(Q) ; Q:=Nil ;
            END Else
            BEGIN
  ...
  DeuxBud : BEGIN
            ...
            If not EstSpecif('51185') Then
              ...
              Q:=FabricReqCpt2Bud(prepCalc.fb1,prepCalc.fb2,prepCalc.SetTyp,prepCalc.FiltreDev,prepCalc.FiltreEtab,prepCalc.FiltreExo,prepCalc.DeviseEnPivot,Multiple,
                                  ExecCalc.Cpt1,ExecCalc.Cpt2,D21,D22,ExecCalc.Etab,ExecCalc.Devise,ExecCalc.Exo) ;
...
BEGIN
Where:='' ; SQL:='' ; Result:='' ;
Where:=AnalyseCompte(CptIn,fb,False,False) ;
...
Function FabricSpeedReq1 ( fb : TFichierBase ; SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean ; Multiple : TTypeCalc ; CptIn,CptOut : String ; DD1,DD2 : tDateTime; bAnalyseCompte: Boolean ;
                           Devise,Etab,Exo : String) : String ;
Var StCalc,StReq : String ;
    SUM_Montant : String ;
    P : String[2] ;
BEGIN
Result:='' ;
If Not VH^.SpeedCum Then Exit ;
StReq:='' ;
Case Fb Of
  FbGene : StCalc:='SELECT E_GENERAL, E_EXERCICE, ' ;
  FbAux  : StCalc:='SELECT E_AUXILIAIRE, E_EXERCICE, ';
...
StReq:=StReq+StCalc ;
Case fb Of
  fbGene,fbAux,fbJal : If EnDevise(FiltreDev,DeviseEnPivot)
                         Then SUM_Montant:='sum(E_DEBITDEV) E_SUMDEBIT, sum(E_CREDITDEV) E_SUMCREDIT, 0 E_SUMDEBITEURO, 0 E_SUMCREDITEURO, '
                         Else SUM_Montant:='sum(E_DEBIT) E_SUMDEBIT, sum(E_CREDIT) E_SUMCREDIT, 0 E_SUMDEBITEURO, 0 E_SUMCREDITEURO, ' ;
  fbAxe1..fbAxe5 : If EnDevise(FiltreDev,DeviseEnPivot)
                         Then SUM_Montant:='sum(Y_DEBITDEV) Y_SUMDEBIT, sum(Y_CREDITDEV) Y_SUMCREDIT, 0 Y_SUMDEBITEURO, 0 Y_SUMCREDITEURO,  '
                         Else SUM_Montant:='sum(Y_DEBIT) Y_SUMDEBIT, sum(Y_CREDIT) Y_SUMCREDIT, 0 Y_SUMDEBITEURO, 0 Y_SUMCREDITEURO, ' ;
  END ;
Case fb Of
  fbGene,fbAux,fbJal : StCalc:=SUM_MONTANT+'E_ECRANOUVEAU, E_QUALIFPIECE FROM ECRITURE ' ;
  fbAxe1..fbAxe5 : StCalc:=SUM_MONTANT+'Y_ECRANOUVEAU, Y_QUALIFPIECE FROM ANALYTIQ ' ;
  END ;
if bAnalyseCompte And ((CptIn<>'') Or (CptOut<>'')) then
  Case fb Of
    fbGene : StCalc:=StCalc+' LEFT JOIN GENERAUX ON E_GENERAL=G_GENERAL ' ;
    fbAux : StCalc:=StCalc+' LEFT JOIN TIERS ON E_AUXILIAIRE=T_AUXILIAIRE ' ;
    fbAxe1..fbAxe5 : StCalc:=StCalc+' LEFT JOIN SECTION ON Y_SECTION=S_SECTION ' ;
    END ;
StReq:=StReq+StCalc ;
Case Fb Of
  FbGene : StCalc:='WHERE E_DATECOMPTABLE>="'+UsDateTime(DD1)+'" AND E_DATECOMPTABLE<="'+UsDateTime(DD2)+'" ' ;
  FbAux  : StCalc:='WHERE E_DATECOMPTABLE>="'+UsDateTime(DD1)+'" AND E_DATECOMPTABLE<="'+UsDateTime(DD2)+'" ';
  fbAxe1..fbAxe5 : StCalc:='WHERE Y_AXE="'+fbToAxe(fb)+'" AND Y_DATECOMPTABLE>="'+UsDateTime(DD1)+'" AND Y_DATECOMPTABLE<="'+UsDateTime(DD2)+'" ' ;
  FbJal  : StCalc:='WHERE E_DATECOMPTABLE>="'+UsDateTime(DD1)+'" AND E_DATECOMPTABLE<="'+UsDateTime(DD2)+'" ';
  END ;
if bAnalyseCompte then
  begin
  StReq:=StReq+StCalc ;
  StCalc:=WhereCpt(fb,CptIn,CptOut) ; If StCalc<>'' Then StReq:=StReq+StCalc ;
  end else StReq:=StReq+StCalc ;
If FiltreDev Then
   BEGIN
   Case Fb Of
     FbGene,FbAux,fbJal : StCalc:='AND E_DEVISE="'+Devise+'" ' ;
...
If FiltreExo Then
   ...
   END ;
P:='E_' ; If fb In [fbAxe1..fbAxe5] Then P:='Y_' ;
StCalc:=WhereSupp(P,SetTyp) ; If StCalc<>'' Then StReq:=StReq+StCalc ;
Case Fb Of
  FbGene : StCalc:='GROUP BY E_GENERAL,E_EXERCICE,E_ECRANOUVEAU,E_QUALIFPIECE ' ;
  FbAux  : StCalc:='GROUP BY E_AUXILIAIRE,E_EXERCICE,E_ECRANOUVEAU,E_QUALIFPIECE ' ;
  fbAxe1..fbAxe5 : StCalc:='GROUP BY Y_SECTION,Y_EXERCICE,Y_ECRANOUVEAU,Y_QUALIFPIECE ' ;
...
{=============================================================================}
Function FabricSpeedReq2 ( fb1,fb2 : TFichierBase ; SetTyp : SetttTypePiece ; FiltreDev,FiltreEtab,FiltreExo,DeviseEnPivot : Boolean ; Multiple : TTypeCalc ; CptIn1,CptOut1,CptIn2,CptOut2 : String ; DD1,DD2 : tDateTime; bAnalyseCompte: Boolean) : String ;
Var StCalc,StReq : String ;
    SUM_Montant : String ;
    P : String[2] ;
    StTable : String ;
...
If Not VH^.SpeedCum Then Exit ;
StReq:='' ;
P:='E_' ; StTable:=' ECRITURE ' ;
If (Fb1 in [fbAxe1..fbAxe5]) Or (Fb2 in [fbAxe1..fbAxe5]) Then BEGIN P:='Y_' ; StTable:=' ANALYTIQ ' ;END ;
Case Fb1 Of
  FbGene : StCalc:='SELECT '+P+'GENERAL, ' ;
  FbAux  : StCalc:='SELECT '+P+'AUXILIAIRE, ';
  fbAxe1..fbAxe5 : StCalc:='SELECT '+P+'SECTION, ' ;
  fbJal : StCalc:='SELECT '+P+'JOURNAL, ' ;
  END ;
Case Fb2 Of
  FbGene : StCalc:=StCalc+P+'GENERAL, '+P+'EXERCICE, ' ;
  FbAux  : StCalc:=StCalc+P+'AUXILIAIRE, '+P+'EXERCICE, ';
  fbAxe1..fbAxe5 : StCalc:=StCalc+P+'SECTION, '+P+'EXERCICE, ' ;
  fbJal : StCalc:=StCalc+P+'JOURNAL, '+P+'EXERCICE, ' ;
  END ;
StReq:=StReq+StCalc ;
If EnDevise(FiltreDev,DeviseEnPivot)
  Then SUM_Montant:='sum('+P+'DEBITDEV) '+P+'SUMDEBIT, sum('+P+'CREDITDEV) '+P+'SUMCREDIT, 0 '+P+'SUMDEBITEURO, 0 '+P+'SUMCREDITEURO, '
  Else SUM_Montant:='sum('+P+'DEBIT) '+P+'SUMDEBIT, sum('+P+'CREDIT) '+P+'SUMCREDIT, 0 '+P+'SUMDEBITEURO, 0 '+P+'SUMCREDITEURO, ' ;
StCalc:=SUM_MONTANT+P+'ECRANOUVEAU, '+P+'QUALIFPIECE FROM '+StTable ;

if bAnalyseCompte And ((CptIn1<>'') Or (CptOut1<>'')) then
  Case fb1 Of
    fbGene : StCalc:=StCalc+' LEFT JOIN GENERAUX ON '+P+'GENERAL=G_GENERAL ' ;
    fbAux : StCalc:=StCalc+' LEFT JOIN TIERS ON E_AUXILIAIRE=T_AUXILIAIRE ' ;
    fbAxe1..fbAxe5 : StCalc:=StCalc+' LEFT JOIN SECTION ON Y_SECTION=S_SECTION ' ;
    END ;
if bAnalyseCompte And ((CptIn2<>'') Or (CptOut2<>'')) then
  Case fb2 Of
    fbGene : StCalc:=StCalc+' LEFT JOIN GENERAUX ON '+P+'GENERAL=G_GENERAL ' ;
    fbAux : StCalc:=StCalc+' LEFT JOIN TIERS ON E_AUXILIAIRE=T_AUXILIAIRE ' ;
    fbAxe1..fbAxe5 : StCalc:=StCalc+' LEFT JOIN SECTION ON Y_SECTION=S_SECTION ' ;
    END ;
StReq:=StReq+StCalc ;
StCalc:='WHERE '+P+'DATECOMPTABLE>="'+UsDateTime(DD1)+'" AND '+P+'DATECOMPTABLE<="'+UsDateTime(DD2)+'" ' ;
If (Fb1 in [fbAxe1..fbAxe5]) THEN StCalc:=StCalc+' AND Y_AXE="'+fbToAxe(fb1)+'"  ' Else
  If (Fb2 in [fbAxe1..fbAxe5]) THEN StCalc:=StCalc+' AND Y_AXE="'+fbToAxe(fb2)+'"  ' ;
if bAnalyseCompte then
  begin
  StReq:=StReq+StCalc ;
  StCalc:=WhereCpt(fb1,CptIn1,CptOut1) ; If StCalc<>'' Then StReq:=StReq+StCalc ;
  StCalc:=WhereCpt(fb2,CptIn2,CptOut2) ; If StCalc<>'' Then StReq:=StReq+StCalc ;
  end else StReq:=StReq+StCalc ;
If FiltreDev Then BEGIN StCalc:=' AND '+P+'DEVISE=:DEV ' ; StReq:=StReq+StCalc ; END ;
If FiltreEtab Then BEGIN StCalc:='AND '+P+'ETABLISSEMENT=:ETAB ' ; StReq:=StReq+StCalc ; END ;
If FiltreExo Then BEGIN StCalc:='AND '+P+'EXERCICE=:EXO ' ; StReq:=StReq+StCalc ; END ;
StCalc:=WhereSupp(P,SetTyp) ; If StCalc<>'' Then StReq:=StReq+StCalc ;
StCalc:=' GROUP BY ' ;
Case Fb1 Of
  FbGene : StCalc:=StCalc+P+'GENERAL,' ;
...
(*
Cpt1,Cpt2,TabTot,
SurQuelfb1,SurQuelfb2 : tFichierBase ; SurQuelExo,SurQuelEtab,SurQuelleDevise : String ; QurQuelleDate1,SurQuelleDate2 : tDateTime
RequeteLance : boolean
*)
...
Function SpeedActif(SurQuelfb : tFichierBase ; SurQuelExo,SurQuelEtab,SurQuelleDevise : String ; QurQuelleDate1,SurQuelleDate2 : tDateTime) : Boolean ;
// est-ce que FabricSpeedReq1 a été lancé et sur quoi a-t-il été lancé ?
BEGIN
Result:=FALSE ;
If Not VH^.SpeedCum Then Exit ;
// ...
...
BEGIN
  ...
  Q:=OpenSql('Select CO_CODE,CO_LIBELLE from COMMUN Where CO_TYPE="RBT" And '+
           '(CO_CODE="GEN" Or CO_CODE="TIE" Or CO_CODE="ANA")',True) ;
  {$ELSE}
  Q:=OpenSql('Select CO_CODE,CO_LIBELLE from COMMUN Where CO_TYPE="RBT" And '+
  ...
  While Not Q.EOF do BEGIN
    {$IFDEF CCS3} // FQ 12752
    if EstComptaSansAna and (Uppercase(Q.Fields[1].AsString) = 'ANALYTIQUE') then begin Q.Next; Continue; end;
    {$ENDIF}
