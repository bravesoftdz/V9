...
type
  ...
  TExtPConcept = class(TForm)
    ...
    tsCALCUL: TTabSheet;
    Label17: TLabel;
    SpeedButton23: THSpeedButton;
    SpeedButton24: THSpeedButton;
    SpeedButton25: THSpeedButton;
    SpeedButton26: THSpeedButton;
    SpeedButton27: THSpeedButton;
    SpeedButton28: THSpeedButton;
    Label9: TLabel;
    SpeedButton29: THSpeedButton;
    SpeedButton31: THSpeedButton;
    SpeedButton1: THSpeedButton;
    SpeedButton2: THSpeedButton;
    SpeedButton14: THSpeedButton;
    SpeedButton15: THSpeedButton;
    Label26: TLabel;
    lbChampNum: TListBox;
    Button2: TButton;
    ...
    SpeedButton3: THSpeedButton;
    SpeedButton4: THSpeedButton;
    SpeedButton5: THSpeedButton;
    SpeedButton6: THSpeedButton;
    SpeedButton8: THSpeedButton;
    SpeedButton9: THSpeedButton;
    SpeedButton10: THSpeedButton;
    SpeedButton11: THSpeedButton;
    SpeedButton7: THSpeedButton;
    SpeedButton12: THSpeedButton;
    SpeedButton13: THSpeedButton;
    SpeedButton30: THSpeedButton;
    ...
    Memo3: THRichEditOLE;
    SpeedButton16: THSpeedButton;
    SpeedButton17: THSpeedButton;
    SpeedButton18: THSpeedButton;
    SpeedButton19: THSpeedButton;
    SpeedButton20: THSpeedButton;
    SpeedButton21: THSpeedButton;
    SpeedButton22: THSpeedButton;
    SpeedButton32: THSpeedButton;
    SpeedButton33: THSpeedButton;
    SpeedButton34: THSpeedButton;
    SpeedButton35: THSpeedButton;
    SpeedButton36: THSpeedButton;
    ...
    SpeedButton37: THSpeedButton;
    SpeedButton38: THSpeedButton;
    SpeedButton39: THSpeedButton;
    SpeedButton40: THSpeedButton;
    SpeedButton41: THSpeedButton;
    SpeedButton42: THSpeedButton;
    ...
    CbLngRef: TCheckBox;
    SpeedButton43: THSpeedButton;
    SpeedButton44: THSpeedButton;
    SpeedButton45: THSpeedButton;
    SpeedButton46: THSpeedButton;
    SpeedButton47: THSpeedButton;
    SpeedButton48: THSpeedButton;
    SpeedButton49: THSpeedButton;
    SpeedButton50: THSpeedButton;
    SpeedButton51: THSpeedButton;
    SpeedButton52: THSpeedButton;
    SpeedButton53: THSpeedButton;
    SpeedButton54: THSpeedButton;
    Interne: TCheckBox;
    MemoComment: TMemo;
    Imprimer1: TMenuItem;
    SpeedButton55: THSpeedButton;
    SpeedButton56: THSpeedButton;
...
begin
       ...
       begin
         if (tvChamp.Selected.level = 1) then    // avec flêche en bas pas positionnement
         begin
           idx := tvChamp.Selected.AbsoluteIndex;
           if idx > 0 then
            ChampNom.Text := tvChamp.Items.Item[idx].Text;
         end;
       end;
...
{$ENDIF}
        ...
        begin
                 ...
                 RTypefichier.ItemIndex := 0; //FScript.ASCIIMODE;
...
begin
    ...
    RefConditionExit (Sender);
  tbSauver := TADOTable.Create(Application);
  tbSauver.Connection := DMImport.Db as TADOConnection;
  tbSauver.TableName := DMImport.GzImpReq.TableName;
	...
	begin
     ...
     begin
        ...
        if FScriptDel = nil then exit;
        TbDelim := TADOTable.Create(Application);
        TbDelim.TableName := DMImport.GzImpDelim.TableName;
        TbDelim.Connection := DMImport.Db as TADOConnection;
        with TbDelim do
        begin
		            Open;
...
{$IFNDEF EAGLCLIENT}
              ...
              begin
                   if Radiotable.ItemIndex = 0  then
                      ScriptVisu (NameE, ListeEnreg,Okplus, RTypefichier.ItemIndex,'', ListeOrder);
              end
              else
                      ScriptVisu (NameEnrg, nil, FALSE,RTypefichier.ItemIndex);
{$ENDIF}
              ListeEnreg.free;
              ListeOrder.free;
        end;
    ...
    begin
         ...
         try
            ...
            begin
              ...
              CallBackDlg.Free;
{$IFNDEF EAGLCLIENT}
                 ScriptVisu (NameEnr, ListeEnreg,FALSE, RTypefichier.ItemIndex, RendLORDER);
{$ENDIF}
              ListeEnreg.free;
            end;
          end;
...
begin
    ...
    TChampNode(tvChamp.Selected.Data).FChamp.LOrder := '';
    TvChamp.Update;
