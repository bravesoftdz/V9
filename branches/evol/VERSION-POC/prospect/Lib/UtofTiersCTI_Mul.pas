...
if (GetControlText('SANSSELECT') <> 'X') then
   ...
   if (not GetParamSocSecur('SO_RTCTIMODACTEFFECT',False)) then WhereUpdate:='';
   ...
   if (GetParamSocSecur('SO_RTCTIMODACTEFFECT',False)) and (GetCheckBoxState('EXISTE')=cbChecked) then
