inherited FTvaValid: TFTvaValid
  Left = 102
  Top = 124
  Width = 623
  Height = 396
  HelpContext = 999999982
  Caption = 'Validation des '#233'ditions de TVA sur encaissements'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited FListe: THDBGrid
    Width = 586
    Height = 159
    OnDblClick = BZoomPieceClick
    MultiSelection = True
    MultiFieds = 'E_JOURNAL;E_DATECOMPTABLE;E_NUMEROPIECE;E_NUMLIGNE;'
  end
  ...
  object HM: THMsgBox
    ...
    Mess.Strings = (
      'ATTENTION. Modification non enregistr'#233'e !'
        ...
        '1;?caption?;Confirmez-vous la validation des '#233'critures '#233'dit'#233'es ?' +
        ';Q;YN;Y;Y;'
      '2;?caption?;Vous n'#39'avez s'#233'lectionn'#233' aucune '#233'criture;W;O;O;O;')
    Left = 352
    Top = 280
  end
end
