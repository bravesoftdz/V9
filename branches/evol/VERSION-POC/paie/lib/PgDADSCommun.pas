...
begin
  ...
  begin
     ...
     Debug('Paie PGI/Calcul TD Bilatéral : PDH_ADRNUM');
  end;
  ...
  begin
     ...
     Debug('Paie PGI/Calcul TD Bilatéral : PDH_ADRNOM');
  end;
...
5 chiffres}
  ...
  begin
     ...
     Debug('Paie PGI/Calcul TD Bilatéral : PDH_CODEPOSTAL');
  end;
...
{On ne récupère la ville que si elle est renseignée, sinon, message d'erreur}
  ...
  begin
     ...
     Debug('Paie PGI/Calcul TD Bilatéral : PDH_BUREAUDISTRIB');
  end;
end;
