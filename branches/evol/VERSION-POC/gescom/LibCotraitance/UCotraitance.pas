...
type
  TModegestion = (TmgIntervenant,TmgCotraitance,TmgSousTraitance);
	...
	TPieceCotrait = class (Tobject)
      ...
      fPOPYItem : array[0..2] of TmenuItem;
...
begin
  ...
  begin
    if (VH_GC.BTCODESPECIF = '001')  then
    begin
      if (fTOBpiece.GetString('GP_NATUREPIECEG')<>'FBT') and (fMenuItem [Indice].Name <> 'BGESTSOUSTRAIT') then fMenuItem[Indice].visible := State;
    end else
    begin
  ...
  begin
    ...
    begin
      if (VH_GC.BTCODESPECIF = '001')  then
      begin
        if ((fTOBpiece.GetString('GP_NATUREPIECEG')<>'FBT') and (fPOPYItem [Indice].Name <> 'PAIESTPOC')) or
           ((fTOBpiece.GetString('GP_NATUREPIECEG')='FBT') and (fPOPYItem [Indice].Name = 'PAIESTPOC')) then fPOPYItem[Indice].visible := State;
      end else
      begin
