...
uses ComCtrls, StdCtrls, uTablesGed;
...
Créé le ...... : 19/01/2006
Modifié le ... :   /  /
Description .. : Procédure appelé pour mettre à jour un Base < 730
Suite ........ :
Suite ........ : Prend en charge aussi la gestion des nouveaux FILEID
Suite ........ : concernant la GED.
Mots clefs ... :
*****************************************************************}
...
begin
  ...
  begin
    ...
    ExecuteSQL('UPDATE JUEVENEMENT SET JEV_OUTLOOK="-", JEV_NODOSSIER="", JEV_DOMAINEACT=""') ;
...
Begin
  ...
  begin
    ...
    //giga
    executesql ('update contact set c_codeper=0');
