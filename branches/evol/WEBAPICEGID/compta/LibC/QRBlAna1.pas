...
uses
  ...
  CpteUtil, Section, HSysMenu, Menus, HTB97, HPanel, UiUtil, tCalcCum  ;

procedure BLAnal ;
procedure BLAnalZoom(Crit : TCritEdt) ;

type
  TFQRBLANA1 = class(TFQR)
...
BEGIN
PP:=FindInsidePanel ;
QR:=TFQRBLANA1.Create(Application) ;
...
Procedure TFQRBLANA1.BalSectionZoom(Quoi : String) ;
BEGIN
Inherited ;
ZoomEdt(3,Quoi) ;
END ;

Procedure TFQRBLANA1.FinirPrint ;
BEGIN
Inherited ;
...
procedure TFQRBLANA1.InitDivers ;
BEGIN
Inherited ;
...
procedure TFQRBLANA1.GenereSQL ;
...
procedure TFQRBLANA1.RenseigneCritere ;
...
procedure TFQRBLANA1.ChoixEdition ;
BEGIN
Inherited ;
...
procedure TFQRBLANA1.RecupCritEdt ;
...
Function TFQRBLANA1.CritOK : Boolean ;
BEGIN
...
Function TFQRBLANA1.ColonnesOK : Boolean ;
BEGIN
...
Procedure TFQRBLANA1.CalcTotalEdt(AnVD, AnVC, D, C : Double );
...
procedure TFQRBLANA1.FormShow(Sender: TObject);
begin
HelpContext:=7451000 ;
...
procedure TFQRBLANA1.FormCreate(Sender: TObject);
begin
  inherited;
ListeCodesRupture:=TStringList.Create ;
end;

procedure TFQRBLANA1.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
ListeCodesRupture.Free ;
end;

procedure TFQRBLANA1.TOPREPORTBeforePrint(var PrintBand: Boolean;  var Quoi: string);
begin
  inherited;
...
procedure TFQRBLANA1.BDetailBeforePrint(var PrintBand: Boolean;  var Quoi: string);
...
procedure TFQRBLANA1.BRUPTBeforePrint(var PrintBand: Boolean;  var Quoi: string);
begin
  inherited;
PrintBand:=(CritEdt.Bal.RuptOnly<>Sans) ;
end;

procedure TFQRBLANA1.BFinEtatBeforePrint(var PrintBand: Boolean;  var Quoi: string);
begin
  inherited;
...
procedure TFQRBLANA1.DLruptNeedData(var MoreData: Boolean);
...
procedure TFQRBLANA1.FNatureCptChange(Sender: TObject);
begin
...
procedure TFQRBLANA1.BOTTOMREPORTBeforePrint(var PrintBand: Boolean;  var Quoi: string);
Var MReport : TabTRep ;
begin
  inherited;
...
procedure TFQRBLANA1.QAfterOpen(DataSet: TDataSet);
begin
  inherited;
...
Function TFQRBLANA1.OkPourRupt : Boolean ;
Var i : Integer ;
BEGIN
Result:=True ;
...
procedure TFQRBLANA1.FExerciceChange(Sender: TObject);
begin
FLoading:=TRUE ;
  inherited;
...
procedure TFQRBLANA1.FDateCompta1Change(Sender: TObject);
begin
  inherited;
...
procedure TFQRBLANA1.FSelectCpteChange(Sender: TObject);
begin
  inherited;
VoirQuelAN(FSelectCpte.Value,FExercice.Value,FDateCompta1,FAvecAN) ;
end;

procedure TFQRBLANA1.FAvecANClick(Sender: TObject);
begin
  inherited;
FCol1.Checked:=FAvecAN.Checked ;
end;

procedure TFQRBLANA1.FRupturesClick(Sender: TObject);
begin
  inherited;
...
procedure TFQRBLANA1.FSansRuptClick(Sender: TObject);
begin
  inherited;
...
procedure TFQRBLANA1.DLRUPTTRINeedData(var MoreData: Boolean);
...
procedure TFQRBLANA1.BRuptTRIBeforePrint(var PrintBand: Boolean;
  var Quoi: String);
begin
  inherited;
...
procedure TFQRBLANA1.BDetailAfterPrint(BandPrinted: Boolean);
begin
  inherited;
BDetail.ForceNewPage:=FALSE ;
end;

procedure TFQRBLANA1.BRUPTAfterPrint(BandPrinted: Boolean);
begin
  inherited;
