...
// PASTLWTR : 1.2
// Fichier généré le 14/05/2014 17:16:41 depuis la bibliothèque de types ci-dessous.
...
// LCID: 0
// Fichier d'aide : 
// Chaîne d'aide : Microsoft XML, v4.0
// DepndLst: 
...
//   Remarque : paramètre 'var' dans IXMLDOMSchemaCollection.add changé en 'var_'
//   Remarque : le symbole 'type' a été renommé en 'type_'
//   Remarque : paramètre 'type' dans ISchemaElement.type changé en 'type_'
//   Remarque : le symbole 'type' a été renommé en 'type_'
//   Remarque : paramètre 'type' dans ISchemaAttribute.type changé en 'type_'
//   Remarque : le symbole 'type' a été renommé en 'type_'
//   Remarque : le symbole 'type' a été renommé en 'type_'
// ************************************************************************ //
// *************************************************************************//
...
// créer des instances de l'interface par défaut IXMLDOMDocument2 exposée             
// par la CoClasse DOMDocument. Les fonctions sont destinées à être utilisées par            
...
// Interface par défaut : IXMLDOMDocument2
// DISP Int. Déf. ?     : No
...
// *********************************************************************//
// La classe CoDOMDocument26 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLDOMDocument2 exposée             
// par la CoClasse DOMDocument26. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoDOMDocument30 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLDOMDocument2 exposée             
// par la CoClasse DOMDocument30. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoDOMDocument40 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLDOMDocument2 exposée             
// par la CoClasse DOMDocument40. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoFreeThreadedDOMDocument fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLDOMDocument2 exposée             
// par la CoClasse FreeThreadedDOMDocument. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : W3C-DOM XML Document (Free threaded)
// Interface par défaut : IXMLDOMDocument2
// DISP Int. Déf. ?     : No
// Interface événements : XMLDOMDocumentEvents
// TypeFlags            : (2) CanCreate
...
// *********************************************************************//
// La classe CoFreeThreadedDOMDocument26 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLDOMDocument2 exposée             
// par la CoClasse FreeThreadedDOMDocument26. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoFreeThreadedDOMDocument30 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLDOMDocument2 exposée             
// par la CoClasse FreeThreadedDOMDocument30. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoFreeThreadedDOMDocument40 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLDOMDocument2 exposée             
// par la CoClasse FreeThreadedDOMDocument40. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoXMLSchemaCache fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLDOMSchemaCollection exposée             
// par la CoClasse XMLSchemaCache. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : object for caching schemas
// Interface par défaut : IXMLDOMSchemaCollection
// DISP Int. Déf. ?     : No
...
// *********************************************************************//
// La classe CoXMLSchemaCache26 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLDOMSchemaCollection exposée             
// par la CoClasse XMLSchemaCache26. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoXMLSchemaCache30 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLDOMSchemaCollection exposée             
// par la CoClasse XMLSchemaCache30. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoXMLSchemaCache40 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLDOMSchemaCollection2 exposée             
// par la CoClasse XMLSchemaCache40. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : object for caching schemas
// Interface par défaut : IXMLDOMSchemaCollection2
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoXSLTemplate fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXSLTemplate exposée             
// par la CoClasse XSLTemplate. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoXSLTemplate = class
...
// Chaîne d'aide        : object for caching compiled XSL stylesheets
// Interface par défaut : IXSLTemplate
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoXSLTemplate26 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXSLTemplate exposée             
// par la CoClasse XSLTemplate26. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoXSLTemplate30 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXSLTemplate exposée             
// par la CoClasse XSLTemplate30. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoXSLTemplate40 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXSLTemplate exposée             
// par la CoClasse XSLTemplate40. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoDSOControl fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IDSOControl exposée             
// par la CoClasse DSOControl. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoDSOControl = class
...
// Interface par défaut : IDSOControl
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoDSOControl26 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IDSOControl exposée             
// par la CoClasse DSOControl26. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoDSOControl30 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IDSOControl exposée             
// par la CoClasse DSOControl30. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoDSOControl40 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IDSOControl exposée             
// par la CoClasse DSOControl40. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoXMLHTTP fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLHTTPRequest exposée             
// par la CoClasse XMLHTTP. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoXMLHTTP = class
...
// *********************************************************************//
// La classe CoXMLHTTP26 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLHTTPRequest exposée             
// par la CoClasse XMLHTTP26. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoXMLHTTP26 = class
...
// *********************************************************************//
// La classe CoXMLHTTP30 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLHTTPRequest exposée             
// par la CoClasse XMLHTTP30. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoXMLHTTP30 = class
...
// *********************************************************************//
// La classe CoXMLHTTP40 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IXMLHTTPRequest exposée             
// par la CoClasse XMLHTTP40. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoXMLHTTP40 = class
...
// *********************************************************************//
// La classe CoServerXMLHTTP fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IServerXMLHTTPRequest2 exposée             
// par la CoClasse ServerXMLHTTP. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : Server XML HTTP Request class.
// Interface par défaut : IServerXMLHTTPRequest2
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoServerXMLHTTP30 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IServerXMLHTTPRequest2 exposée             
// par la CoClasse ServerXMLHTTP30. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoServerXMLHTTP40 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IServerXMLHTTPRequest2 exposée             
// par la CoClasse ServerXMLHTTP40. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoSAXXMLReader fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IVBSAXXMLReader exposée             
// par la CoClasse SAXXMLReader. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : SAX XML Reader (version independent) coclass
// Interface par défaut : IVBSAXXMLReader
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoSAXXMLReader30 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IVBSAXXMLReader exposée             
// par la CoClasse SAXXMLReader30. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : SAX XML Reader 3.0 coclass
// Interface par défaut : IVBSAXXMLReader
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
...
// *********************************************************************//
// La classe CoSAXXMLReader40 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IVBSAXXMLReader exposée             
// par la CoClasse SAXXMLReader40. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : SAX XML Reader 4.0 coclass
// Interface par défaut : IVBSAXXMLReader
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
...
// *********************************************************************//
// La classe CoMXXMLWriter fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMXWriter exposée             
// par la CoClasse MXXMLWriter. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoMXXMLWriter = class
...
// Chaîne d'aide        : Microsoft XML Writer (version independent) coclass
// Interface par défaut : IMXWriter
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoMXXMLWriter30 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMXWriter exposée             
// par la CoClasse MXXMLWriter30. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : Microsoft XML Writer 3.0 coclass
// Interface par défaut : IMXWriter
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
...
// *********************************************************************//
// La classe CoMXXMLWriter40 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMXWriter exposée             
// par la CoClasse MXXMLWriter40. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : Microsoft XML Writer 4.0 coclass
// Interface par défaut : IMXWriter
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
...
// *********************************************************************//
// La classe CoMXHTMLWriter fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMXWriter exposée             
// par la CoClasse MXHTMLWriter. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : Microsoft HTML Writer (version independent) coclass
// Interface par défaut : IMXWriter
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
...
// *********************************************************************//
// La classe CoMXHTMLWriter30 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMXWriter exposée             
// par la CoClasse MXHTMLWriter30. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : Microsoft HTML Writer 3.0 coclass
// Interface par défaut : IMXWriter
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
...
// *********************************************************************//
// La classe CoMXHTMLWriter40 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMXWriter exposée             
// par la CoClasse MXHTMLWriter40. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : Microsoft HTML Writer 4.0 coclass
// Interface par défaut : IMXWriter
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
...
// *********************************************************************//
// La classe CoSAXAttributes fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMXAttributes exposée             
// par la CoClasse SAXAttributes. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : SAX Attributes (version independent) coclass
// Interface par défaut : IMXAttributes
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoSAXAttributes30 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMXAttributes exposée             
// par la CoClasse SAXAttributes30. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : SAX Attributes 3.0 coclass
// Interface par défaut : IMXAttributes
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
...
// *********************************************************************//
// La classe CoSAXAttributes40 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IMXAttributes exposée             
// par la CoClasse SAXAttributes40. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : SAX Attributes 4.0 coclass
// Interface par défaut : IMXAttributes
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
...
// *********************************************************************//
// La classe CoMXNamespaceManager fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IVBMXNamespaceManager exposée             
// par la CoClasse MXNamespaceManager. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : MX Namespace Manager coclass
// Interface par défaut : IVBMXNamespaceManager
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
...
// *********************************************************************//
// La classe CoMXNamespaceManager40 fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IVBMXNamespaceManager exposée             
// par la CoClasse MXNamespaceManager40. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// Chaîne d'aide        : MX Namespace Manager 4.0 coclass
// Interface par défaut : IVBMXNamespaceManager
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
...
// par la CoClasse XMLDocument. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoXMLDocument = class
...
procedure TDOMDocument._Set_schemas(otherCollection: OleVariant);
  { Avertissement : cette propriété schemas a un setter et un getter dont
...
procedure TXSLTemplate._Set_stylesheet(const stylesheet: IXMLDOMNode);
  { Avertissement : cette propriété stylesheet a un setter et un getter dont
    les types ne sont pas en concordance. Delphi n'a pas pu générer une propriété
    de cette sorte et utilise donc un Variant à la place. }
var
  InterfaceVariant: OleVariant;
...
procedure TSAXXMLReader._Set_entityResolver(const oResolver: IVBSAXEntityResolver);
  { Avertissement : cette propriété entityResolver a un setter et un getter dont
    les types ne sont pas en concordance. Delphi n'a pas pu générer une propriété
    de cette sorte et utilise donc un Variant à la place. }
var
  InterfaceVariant: OleVariant;
...
procedure TSAXXMLReader._Set_contentHandler(const oHandler: IVBSAXContentHandler);
  { Avertissement : cette propriété contentHandler a un setter et un getter dont
    les types ne sont pas en concordance. Delphi n'a pas pu générer une propriété
    de cette sorte et utilise donc un Variant à la place. }
var
  InterfaceVariant: OleVariant;
...
procedure TSAXXMLReader._Set_dtdHandler(const oHandler: IVBSAXDTDHandler);
  { Avertissement : cette propriété dtdHandler a un setter et un getter dont
    les types ne sont pas en concordance. Delphi n'a pas pu générer une propriété
    de cette sorte et utilise donc un Variant à la place. }
var
  InterfaceVariant: OleVariant;
...
procedure TSAXXMLReader._Set_errorHandler(const oHandler: IVBSAXErrorHandler);
  { Avertissement : cette propriété errorHandler a un setter et un getter dont
    les types ne sont pas en concordance. Delphi n'a pas pu générer une propriété
    de cette sorte et utilise donc un Variant à la place. }
var
  InterfaceVariant: OleVariant;
...
procedure TSAXXMLReader.Set_baseURL(const strBaseURL: WideString);
  { Avertissement : cette propriété baseURL a un setter et un getter dont
    les types ne sont pas en concordance. Delphi n'a pas pu générer une propriété
    de cette sorte et utilise donc un Variant à la place. }
var
  InterfaceVariant: OleVariant;
...
procedure TSAXXMLReader.Set_secureBaseURL(const strSecureBaseURL: WideString);
  { Avertissement : cette propriété secureBaseURL a un setter et un getter dont
    les types ne sont pas en concordance. Delphi n'a pas pu générer une propriété
    de cette sorte et utilise donc un Variant à la place. }
var
  InterfaceVariant: OleVariant;
...
procedure TMXXMLWriter.Set_encoding(const strEncoding: WideString);
  { Avertissement : cette propriété encoding a un setter et un getter dont
    les types ne sont pas en concordance. Delphi n'a pas pu générer une propriété
    de cette sorte et utilise donc un Variant à la place. }
var
  InterfaceVariant: OleVariant;
...
procedure TMXXMLWriter.Set_version(const strVersion: WideString);
  { Avertissement : cette propriété version a un setter et un getter dont
    les types ne sont pas en concordance. Delphi n'a pas pu générer une propriété
    de cette sorte et utilise donc un Variant à la place. }
var
  InterfaceVariant: OleVariant;
