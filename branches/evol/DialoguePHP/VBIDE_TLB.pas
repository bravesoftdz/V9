...
// PASTLWTR : 1.2
// Fichier généré le 18/07/2011 15:31:55 depuis la bibliothèque de types ci-dessous.

// ************************************************************************  //
// Bibl. types : C:\Program Files\Common Files\Microsoft Shared\VBA\VBA6\VBE6EXT.OLB (1)
// LIBID: {0002E157-0000-0000-C000-000000000046}
// LCID: 0
// Fichier d'aide : C:\Program Files\Common Files\Microsoft Shared\VBA\VBA6\vbob6.chm
// Chaîne d'aide : Microsoft Visual Basic for Applications Extensibility 5.3
// DepndLst: 
...
// Erreurs :
//   Remarque : le typeinfo Property a été changé en Property_
//   Remarque : le symbole 'Type' a été renommé en 'type_'
//   Remarque : le symbole 'Type' a été renommé en 'type_'
//   Remarque : paramètre 'Type' dans _VBProjects.Add changé en 'Type_'
//   Remarque : le symbole 'Type' a été renommé en 'type_'
//   Conseil : Membre 'Object' de 'Property' modifié en 'Object_'
//   Conseil : Membre 'Object' de 'AddIn' modifié en 'Object_'
//   Remarque : paramètre 'String' dans _CodeModule.AddFromString changé en 'String_'
//   Remarque : paramètre 'String' dans _CodeModule.Lines changé en 'String_'
//   Remarque : paramètre 'String' dans _CodeModule.InsertLines changé en 'String_'
//   Remarque : paramètre 'String' dans _CodeModule.ReplaceLine changé en 'String_'
//   Remarque : le symbole 'Type' a été renommé en 'type_'
// ************************************************************************ //
// *************************************************************************//
// REMARQUE :                                                                      
...
// *********************************************************************//
// Constantes pour enum vbextFileTypes
type
...
// Constantes pour enum vbext_WindowType
type
...
// Constantes pour enum vbext_WindowState
type
...
// Constantes pour enum vbext_ProjectType
type
...
// Constantes pour enum vbext_ProjectProtection
type
...
// Constantes pour enum vbext_VBAMode
type
...
// Constantes pour enum vbext_ComponentType
type
...
// Constantes pour enum vbext_ProcKind
type
...
// Constantes pour enum vbext_CodePaneview
type
...
// Constantes pour enum vbext_RefKind
type
...
// *********************************************************************//
// La classe CoWindows fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _Windows exposée             
// par la CoClasse Windows. Les fonctions sont destinées à être utilisées par            
...
// *********************************************************************//
// La classe CoLinkedWindows fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _LinkedWindows exposée             
// par la CoClasse LinkedWindows. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoReferencesEvents fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _ReferencesEvents exposée             
// par la CoClasse ReferencesEvents. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoCommandBarEvents fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _CommandBarControlEvents exposée             
// par la CoClasse CommandBarEvents. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoProjectTemplate fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _ProjectTemplate exposée             
// par la CoClasse ProjectTemplate. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoVBProject fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _VBProject exposée             
// par la CoClasse VBProject. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoVBProject = class
...
// *********************************************************************//
// La classe CoVBProjects fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _VBProjects exposée             
// par la CoClasse VBProjects. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoVBProjects = class
...
// *********************************************************************//
// La classe CoComponents fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _Components exposée             
// par la CoClasse Components. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoComponents = class
...
// *********************************************************************//
// La classe CoVBComponents fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _VBComponents exposée             
// par la CoClasse VBComponents. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
...
// *********************************************************************//
// La classe CoVBComponent fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _VBComponent exposée             
// par la CoClasse VBComponent. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoVBComponent = class
...
// *********************************************************************//
// La classe CoProperties fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _Properties exposée             
// par la CoClasse Properties. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoProperties = class
...
// *********************************************************************//
// La classe CoAddins fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _AddIns exposée             
// par la CoClasse Addins. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoAddins = class
...
// *********************************************************************//
// La classe CoCodeModule fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _CodeModule exposée             
// par la CoClasse CodeModule. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoCodeModule = class
...
// *********************************************************************//
// La classe CoCodePanes fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _CodePanes exposée             
// par la CoClasse CodePanes. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoCodePanes = class
...
// *********************************************************************//
// La classe CoCodePane fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _CodePane exposée             
// par la CoClasse CodePane. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoCodePane = class
...
// *********************************************************************//
// La classe CoReferences fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut _References exposée             
// par la CoClasse References. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoReferences = class
