...
{$ENDIF}
  ...
  begin
		if Not JaiLeDroitConcept(TConcept(bt110),False) then stArg:= 'ACTION=CONSULTATION;';
  end else
 		if Not JaiLeDroitConcept(TConcept(bt111),False) then stArg:= 'ACTION=CONSULTATION;';
