...
{$ENDIF}
     ...
     ;
function GetAllSelectFields(Table : String) : String ;
var
   Pref : String ;
   NumTable, i : Integer ;
begin
    ...
    begin
      ...
      begin
        ...
        begin
          if Result <> '' then
             Result := Result + ',' ;
          Result := Result+V_PGI.DEChamps[NumTable,i].Nom ;
        end;
      end;
    end;
end;
...
begin
if TypeRech = 'A' then
   result := ExisteSQL('SELECT '+ NomChamp1 + ' FROM '+ NomTable +' WHERE '+ NomChamp1 + ' ="'
          + GetField('C_AUXILIAIRE') + '" AND '+ NomChamp2 + '='+IntToStr(GetField('C_NUMEROCONTACT')))
else
   result := ExisteSQL('SELECT '+ NomChamp1 + ' FROM '+ NomTable +' WHERE '+ NomChamp1 + ' ="'
          + TiersAuxiliaire(GetField('C_AUXILIAIRE'),True) + '" AND '+ NomChamp2 + '='+IntToStr(GetField('C_NUMEROCONTACT')));
