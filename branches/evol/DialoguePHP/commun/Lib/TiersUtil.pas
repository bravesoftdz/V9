...
Begin
Result:='';
If AuxiliaireVersTiers Then Begin NomChamp := 'T_AUXILIAIRE'; ChampRetourne := 'T_TIERS'; End
Else Begin NomChamp := 'T_TIERS'; ChampRetourne :='T_AUXILIAIRE' End;
...
begin
   ...
   if NomChamp = 'T_VILLE'     then chp := 'SO_FMTTIERSVILLE' else exit;
end;
if clipart = false then
begin
