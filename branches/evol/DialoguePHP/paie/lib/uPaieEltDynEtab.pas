...
Créé le ...... : 28/02/2007
Modifié le ... :   /  /
Description .. : Unité qui permet de récupérer la tob contenant les éléments dynamiques Etablissement
Mots clefs ... :
*****************************************************************}
...
// Fonction qui renvoie dans une TOB, la liste des éléments dynamiques d'un établissement
