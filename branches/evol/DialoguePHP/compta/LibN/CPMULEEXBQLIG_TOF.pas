...
begin
  ...
  SetControlEnabled('BINSERT', JaiLeDroitConcept(TConcept(ccSaisMvtBqe), False));
  SetControlEnabled('BDELETE', JaiLeDroitConcept(TConcept(ccSaisMvtBqe), False));
  ...
  SetControlEnabled('DEL', JaiLeDroitConcept(TConcept(ccSaisMvtBqe), False));
  SetControlEnabled('INS', JaiLeDroitConcept(TConcept(ccSaisMvtBqe), False));
...
var
  ...
  B : Boolean;
begin
  B := (VarToStr(GetField('CEL_VALIDE')) = 'X') and JaiLeDroitConcept(TConcept(ccSaisMvtBqe), False);
