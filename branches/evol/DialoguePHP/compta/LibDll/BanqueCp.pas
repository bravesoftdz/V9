...
uses SysUtils, WinTypes, WinProcs, Messages, Classes, Graphics, Controls,
  ...
  ComCtrls, HRichEdt, HRichOLE, Hcompte, HRegCpte, HTB97{$ELSE}uDbxDataSet{$ENDIF}, DB, Grids, DBGrids, TabNotBk, CodePost, ComCtrls,
...
begin VerifCodePostal(TBanqueCP,BQ_CODEPOSTAL,BQ_VILLE,TRUE) ; end;

procedure TFbanqueCP.BQ_VILLEDblClick(Sender: TObject);
begin VerifCodePostal(TBanqueCP,BQ_CODEPOSTAL,BQ_VILLE,FALSE) ; end;
