...
{$endif eAGLClient}
  ...
  hctrls, MajTable, uYFILESTD,
  ExtCtrls, inifiles, UTOB, ImgList, LicUtil, UDMIMP, UExport, UToz, cbpPath;
...
BEGIN
   ...
   case Numopt of
     ...
     begin
           ...
           if V_PGI.DosPath[length (V_PGI.DosPath)] <> '\' then  Dospath := V_PGI.DosPath+'\CISX'
