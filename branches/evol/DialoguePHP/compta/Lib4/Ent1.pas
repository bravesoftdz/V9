...
Const { Concepts }
      ...
      {Gestion Commerciale}
      gcArtCreat=61    ; gcArtModif=62   ; gcProspectCreat=63   ;
      gcArtModifCreat=105 ;
      gcForceRisque=64 ; gcCliCreat=65   ; gcSaisModifRepres=66 ; gcAdminECommerce=67 ; gcNumCBComplet=68 ;
      gcOutreVisaMulti=69 ; gcConsultStock=70; gcFouCreat = 71; gcPieceDelete = 72; gcTransfertSusPro=73 ; gcTauxNegocie=74; gcSavMajParc=100; gcSavMajArticleParc=101; gcSavMajVersion=102;
      gcSavMiseEsHs=103; gcSavReaffectEtMaj=104;
      gcProspectModif=110   ; gcCliModif=111   ;
      gcFouModif = 112;
      ...
      { visu tiers 360 }
      gc360Prospect=116; gc360Client=117;
      {Immo PGI}
...
{$IFDEF EAGLCLIENT}
// pas après AGL570d function GetModePCL ( st : string ) : string;
{$ENDIF}
