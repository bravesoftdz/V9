...
{$IFDEF BTP}
        else if (St='LIVRAISON') or (St='FACTURATION') or (st = 'RETOURFOU') then TypeTraitement := st
{$ENDIF}
          else Arg:=Arg+St+';';
      END;
...
begin
   ...
   begin
      ...
      Naturepiece.Plus := ' AND ((GPP_NATUREPIECEG="CF") OR (GPP_NATUREPIECEG="CFR") OR (GPP_NATUREPIECEG="BLF") or (GPP_NATUREPIECEG="LFR"))';
      XX_WHERE.Text :='((GP_NATUREPIECEG="CF") OR (GP_NATUREPIECEG="CFR") OR (GP_NATUREPIECEG="BLF") or (GP_NATUREPIECEG="LFR"))';
   end;
