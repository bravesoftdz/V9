...
uses  UTOM,HCtrls,Classes,Controls,Sysutils,HDB,Forms,Hent1,LicUtil,Graphics,
{$IFDEF EAGLCLIENT}
      UtileAGL,  
{$ELSE}
{$IFDEF V530}
...
if not(ctxmode in V_PGI.PGICOntexte)
   and (V_PGI.PassWord <> CryptageSt(DayPass(V_PGI.DateEntree)))
       then begin
