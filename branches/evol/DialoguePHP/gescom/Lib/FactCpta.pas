...
Var NatureG,PassP : String ;
    TOBEchesCpta  : TOB ;
    NbArtFi       : Integer ; // Nombre d'article financier dans la pièce
    LeAcc         : T_GCAcompte ;
BEGIN
Result:=rcOk ;
NatureG:=TOBPiece.GetValue('GP_NATUREPIECEG') ;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        result := false;
        PGIInfo(TraduireMemoire('Cette pièce est lettrée en comptabilité.'),'ATTENTION');
        break;
      end;
...
begin
  ...
  begin
    ...
    begin
      // -------------------------------------
      // Cas du parcours d'un détail d'ouvrage
      // -------------------------------------
