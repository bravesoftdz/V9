...
var st_NatPiece, st_NatSaisie, st_message: String ;
    i_error : integer;
    QQ : Tquery;
    ModeSaisie : string;
begin
...
begin
{$IFDEF BTP}
   TCheckBox(GetControl('GPP_VISA')).Visible:=True ;
   THEdit(GetControl('GPP_MONTANTVISA')).Visible:=True ;
   THLabel(getControl('TGPP_MONTANTVISA')).Visible:=True ;
{$ELSE}
   TMenuItem(GetControl('mnCompl')).Visible:=False ;
   TCheckBox(GetControl('GPP_VISA')).Visible:=False ;
   THEdit(GetControl('GPP_MONTANTVISA')).Visible:=False ;
   THLabel(getControl('TGPP_MONTANTVISA')).Visible:=False ;
   TTabSheet(GetControl('PAFFAIRE')).TabVisible:=False ;
{$ENDIF}
   TCheckBox(GetControl('GPP_ECLATEDOMAINE')).Visible:=False ;
   TMenuItem(GetControl('mnDomaine')).Visible:=False ;
   ThEdit(GetControl('GPP_LISTESAISIE')).Visible:=False ; THLabel(GetControl('TGPP_LISTESAISIE')).Visible:=False ;
   THEdit(getControl('GPP_LISTEAFFAIRE')).Visible:=False ;
end;
*)
