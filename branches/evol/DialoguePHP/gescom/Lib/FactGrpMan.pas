...
for i:=0 to TOBGenere.Detail.Count-1 do
    ...
    {Qtes}
    TOBL.PutValue('GL_QTERELIQUAT',0)   ; TOBL.PutValue('GL_SOLDERELIQUAT','-') ;
    {Analytique}
...
NewNum:=GetNumSoucheG(NewSouchePiece) ; TOBGenere.PutValue('GP_NUMERO',NewNum) ;
...
if Not PassationComptable(TOBGenere,TOBOuvragesP,TOBBases,TOBBasesL,TOBEches,nil,nil,TOBTiers,TOBArticles,TOBCpta,TOBAcomptes,TOBPorcs,TOBPIECERG,TOBBasesRG,TOBanaP,TOBanaS,DEV,OldEcr,OldStk,True)
...
// DBR Fiche 10665 - Debut
        ...
        end else if TobGenere.GetValue ('GP_DOMAINE') <> stDomaine then
        begin
