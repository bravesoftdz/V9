...
function TOF_AjustStock.QuelChampLigne ( iTableLigne : integer ; NomChamp : String ) : integer ;
var i_ind : integer ;
begin
Result := -1 ;
for i_ind := 1 to High(V_PGI.DEChamps[iTableLigne]) do
    begin
    if V_PGI.DEChamps[iTableLigne,i_ind].Nom=NomChamp then
        begin
         Result:=i_ind ;
         Break ;
        end ;
