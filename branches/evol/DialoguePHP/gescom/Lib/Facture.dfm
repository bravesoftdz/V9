object FFacture: TFFacture
  ...
  object TDescriptif: TToolWindow97
    ...
    object Descriptif: THRichEditOLE
      ...
      LinesRTF.Strings = (
          ...
          '{\rtf1\ansi\ansicpg1252\deff0\deflang1036{\fonttbl{\f0\fnil Time' +
          's New Roman;}}'
  ...
  object Descriptif1: THRichEditOLE
    ...
    LinesRTF.Strings = (
      '{\rtf1\ansi\deff0{\fonttbl{\f0\fnil Times New Roman;}}'
        ...
        '{\*\generator Msftedit 5.41.21.2510;}\viewkind4\uc1\pard\lang103' +
        '6\f0\fs20 Descriptif1'
      '\par }')
  end
      ...
      object DockBottom: TDock97
        ...
        object Outils97: TToolbar97
          ...
          object BAcompte: TToolbarButton97
            ...
            Width = 28
            Height = 27
            Hint = 'Acompte/R'#232'glement'
            AllowAllUp = True
            DisplayMode = dmGlyphOnly
            Caption = 'Acompte/R'#232'glement'
            Enabled = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlack
            Font.Height = -11
  ...
  object HPiece: THMsgBox
    ...
    Mess.Strings = (
      ...
      '32;?caption?;Vous devez renseigner une devise;E;O;O;O;'
        ...
        ';Q;YN;Y;N;'
      '40;?caption?;Erreur sur le code du commercial;E;O;O;O;'
  ...
  object POPY: TPopupMenu
    ...
    object Complmentvariables1: TMenuItem
      Caption = 'Compl'#233'ment variables'
      OnClick = Complmentvariables1Click
    end
    ...
    object MBAnal: TMenuItem
      Caption = 'Analyse'
      object MBAnalDoc: TMenuItem
        Caption = 'Analyse du document'
        OnClick = MBAnalDocClick
      end
      object MBAnalLoc: TMenuItem
        Caption = 'Analyse de l'#39#233'l'#233'ment courant'
        OnClick = MBAnalLocClick
      end
    end
    object SimulationdeRentabilit1: TMenuItem
      Caption = 'Simulation de Rentabilit'#233
      Visible = False
      object SRDocGlobal: TMenuItem
        Caption = 'Document Global'
        OnClick = SRDocGlobalClick
      end
      object SRDocParag: TMenuItem
        Caption = 'Par Paragraphe'
        OnClick = SRDocParagClick
      end
    end
    ...
    object BCOTRAITTABLEAU: TMenuItem
      Caption = 'Tableau r'#233'capitulatif de cotraitance'
    end
