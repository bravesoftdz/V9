...
{$ENDIF}
     EntGC, TiersUtil, FactTOB, FactComm, UtilPGI,uEntCommun ,UtilTOBPiece;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          MessageValid := 'Erreur mise à jour adresses';
  ...
  try
    ...
    begin
      ...
      begin
        ...
        If TobPiece.getvalue('GP_NUMADRESSELIVR') = TobPiece.getvalue('GP_NUMADRESSEFACT') then TOBPiece.PutValue('GP_NUMADRESSEFACT', +2); //mcd 02/10/2003 il faut ds cecas indiquer que les adresse st #
      end else
      begin
