...
Const
    {$IFDEF BUSINESSPLACE}
     ...
     GCCodesSeria : array[1..8] of string =('00083080','00311080','00312080','00313080','00314080','00316080','00416080','14900080');
     GCTitresSeria : array[1..8] of Hstring =('BUSINESS PLACE BTP : Etudes & Situations','BUSINESS PLACE BTP : Récupération des Appels d''offres','BUSINESS PLACE BTP : Achats/Stocks','BUSINESS PLACE BTP : Gestion des chantiers','BUSINESS PLACE BTP : Relations Clients','BUSINESS PLACE BTP : Contrats','BUSINESS PLACE BTP : Interventions','BUSINESS PLACE BTP : Cotraitance');
    {$ELSE}

      {$IFDEF LINE}
     Ent_Message = 'Business Line BTP : ';
     GCCodeDomaine = '00595010' ;
     GCCodesSeria : array[1..2] of string =('00594080', '00648080');
     GCTitresSeria : array[1..2] of Hstring =(Ent_Message + 'Devis-Factures', Ent_Message + 'Gestion Chantiers');
      {$ELSE}
     GCCodeDomaine = '00056010' ;
     GCCodesSeria : array[1..8] of string =('00055080','00084080','00094080','00210080','00254080','00255080','00256080','14901080');
     GCTitresSeria : array[1..8] of Hstring =('BUSINESS SUITE BTP : Etudes & Situations','BUSINESS SUITE BTP : Récupération des Appels d''offres','BUSINESS SUITE BTP : Achats/Stocks','BUSINESS SUITE BTP : Gestion des chantiers','BUSINESS SUITE BTP : Relations Clients','BUSINESS SUITE BTP : Contrats','BUSINESS SUITE BTP : Interventions','BUSINESS SUITE : Cotraitance');
     	{$ENDIF}
