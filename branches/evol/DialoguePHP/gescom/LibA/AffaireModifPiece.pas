...
Type T_ModifPieceAff = Class
       ...
       TOBPorcs,TOBNomenclature,TOBComms,TOBCpta,TOBAnaP,TOBAnaS,TOBAdresses,TOBTarif,TOBPieceTrait : TOB;
       TobLigneTarif: Tob;
...
//---
CalculFacture(TOBPiece,TOBPieceTrait,TOBOuvrage,TOBOuvragesP,TOBBases,TobbasesL,TOBTiers,TOBArticles,TOBPorcs,Nil,Nil,DEV) ;
