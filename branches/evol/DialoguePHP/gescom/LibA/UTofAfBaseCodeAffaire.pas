...
if THEdit(GetControl('GP_VENTEACHAT')) <> Nil then
		VenteAchat := GetControlText('GP_VENTEACHAT');
...
if Ecran.Name = 'BTSAISIECONSO' then
   if EditAff0.text = 'W' then
	    TheEtatAffaire := 'AFF,REA';

if GetAffaireEnteteSt(EditAff0,EditAff1,EditAff2,EditAff3,EditAff4,EditTiers,
					  Affaire,bProposition,bchangeStatut,false,bChangeTiers,BcreatAff,VenteAchat,false,true,false,TheEtatAffaire ) then
begin
  //--- Modif BRL 160604
