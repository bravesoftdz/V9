...
{$IFDEF BTP}
        ...
        begin
          ...
          sNatureCoche := 'ABT;AFF;DBT;FBT;PBT;FPR;FAC;AVC';
...
{$ENDIF}
        ...
        if (sNature='FR') then begin // mcd 13/02/02 pour , depuis les missions avoir FRE en plus fac et avc, sans se positioner sur cette valeur
...
if (PlusCombo<>'') and (NatPieceMul <>Nil)  then begin
