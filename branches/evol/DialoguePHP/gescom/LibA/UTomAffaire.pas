...
//    	  SetField('AFF_DATEDEBGENER', GetField('AFF_DATEDEBUT'));
 ...
 /////////////////////////
    ...
    if (F.FieldName = 'AFF_PERIODICITE') then //*********** Périodicité *************
  begin
    //*** Valeurs par défaut ***
...
{$IFDEF BTP}
    ...
    SetControlProperty ('BTREGROUPE', 'Caption', 'Liste des appels d''offrez re&groupées') ;
...
{$ELSE}
  SetField ('AFF_ETATAFFAIRE', 'ENC') ; // par défaut en gestion d'affaires
{$ENDIF}
