...
BchangeTiers := BBCHangeTiers;
   ...
   if (ctxScot in V_PGI.PGIContexte) then  begin
      if (Ecran).name='ETATSCLIENT' then begin  //mcd 08/03/02
   ...
   If GetControl('Afa_GenerAuto') <> Nil then begin
   ...
   If GetControl('Afa_LIQUIDATIVE') <> Nil then begin
   ...
   if GetControl('AFF_ETABLISSEMENT') IS THValComboBox then
