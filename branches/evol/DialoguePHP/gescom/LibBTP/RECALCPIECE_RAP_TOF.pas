...
Type
  ...
  private
  	TRAITEMANPIECE, TRAITFERMETURE,TRAITEPURATION,TRAITEEPUCHANTIER : boolean;
  	TOBPieces : TOB;
    Memo : Tmemo;
    CalculPv : boolean;
    fermeture : boolean;
...
procedure TraiteRecalculPieces (TOBPieces : TOB; CalculPv : boolean);
Procedure TraiteManPieces (TOBPiece : TOB);
...
begin
  ...
  AglLanceFiche ('BTP','BTRECALCPIECE_RAP','','','TRAITEMANPIECE');
...
begin
  ...
  begin
    ...
    begin
      retourTrait := TraitementRecalculPiece (TOBPieces.detail[Indice],CalculPv);
    ...
    begin
      RetourEpurationChantier := TraitementEpurationChantier (TOBPieces.detail[Indice]);
