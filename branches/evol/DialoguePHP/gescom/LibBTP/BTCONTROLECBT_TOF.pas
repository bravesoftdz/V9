...
begin
  ...
  Chaine := 'Début du contrôle des besoins de chantier à :'+TimeToStr (Now);
	...
	MResult.lines.Add ('--------');
  QQ := OpenSql ('SELECT GL_NATUREPIECEG,GL_DATEPIECE,GL_SOUCHE,GL_NUMERO,GL_INDICEG,GL_NUMORDRE,GL_NUMLIGNE,GL_CODEARTICLE,GL_VIVANTE,GL_QTEFACT,GL_QTERESTE,GL_SOLDERELIQUAT FROM LIGNE WHERE '+
