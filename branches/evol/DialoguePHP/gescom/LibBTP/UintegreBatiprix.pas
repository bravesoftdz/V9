...
{$ENDIF}
  ...
  AglInit,
  Utilarticle,
  BatiprixDataClient_TLB, HFolders, Spin, HDB, GraphicEx,CBPPath
;
  ...
  repeat
    ...
    begin
      ...
      begin
        ...
        begin
        	TOBFAMCHGD := TOBFAMCHG.FindFirst(['BFG_IMPFAMILLE4'],[TOBMATD.GetValue('MAFA_ID')],true);
        end;
        if TOBFAMCHGD = nil then
        begin
        	TOBFAMCHGD := TOBFAMCHG.FindFirst(['BFG_IMPFAMILLE3'],[TOBMATD.GetValue('MAFA_ID')],true);
        end;
        if TOBFAMCHGD = nil then
        begin
        ...
        begin
          ...
          if not TOBARTSD.IsOneModifie (false) then TOBARTSD.free;
        end;
        //
...
begin
  ...
  repeat
    ...
    begin
      ...
      TOBFAMCHGD := TOBFAMCHG.findfirst(['BFG_IMPFAMILLE4'],[TOBOuvrageD.getvalue('OUFA_ID')],true);
    	if TOBFAMCHGD = nil then
    	Begin
				TOBFAMCHGD := TOBFAMCHG.findfirst(['BFG_IMPFAMILLE3'],[TOBOuvrageD.getvalue('OUFA_ID')],true);
      end;
      TitreLib :='';
      TitreMemo := '';
