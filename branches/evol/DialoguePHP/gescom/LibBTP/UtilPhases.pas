...
begin
  ...
  Sql := 'SELECT AFF_AFFAIRE0, AFF_AFFAIREINIT, AFF_LIBELLE FROM AFFAIRE WHERE AFF_AFFAIRE="'+Chantier+'"';
  QQ := OpenSql (SQL,true);
  ...
  begin
    ...
    TOBL.PutValue('BCO_AFFAIRESAISIE', QQ.findfield('AFF_AFFAIREINIT').asString);
  end;
