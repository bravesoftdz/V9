...
begin
  ...
  if GetParamSoc ('SO_BTMETREBIB') then frepertBase := RecupRepertbase
  else frepertbase := '';
...
begin
  if GetParamSoc ('SO_BTMETREBIB') or GetParamSoc ('SO_BTMETREDOC') then frepertBase := RecupRepertbase
  else frepertbase := '';
  fUsable := true;
  ...
  if not ControlMetre (false) then
     Begin
       fUsable := false;
       exit;
     end;
