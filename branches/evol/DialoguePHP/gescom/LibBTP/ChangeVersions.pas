...
uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
	ComCtrls, StdCtrls, Hctrls, ExtCtrls, Hgauge,UTob,EntGc, UtilPGI,MajTable;
...
{$ENDIF}
  ParamSoc,
  Ent1, HmsgBox,UtilSoc,uBTPVerrouilleDossier,TarifUtil; (*,STKMoulinette, yTarifsBascule,Wjetons  ;*)
    ...
    Begin
      ...
      Begin
        ...
        begin
          ...
          TobAdr.Detail[Indice].PutValue('ADR_CLETELEPHONE',CleTelephone(Notel));
        end;
      end;
      TobAdr.SetAllModifie(true);
      TobAdr.InsertOrUpdateDB(False);
    end;
  FINALLY
    Titre.visible := false;
    PB.Visible := false;
...
begin                                                         
	...
	Nb:=ExecuteSQL ('UPDATE PARPIECE SET GPP_MASQUERNATURE="X" WHERE GPP_NATUREPIECEG IN'+
                  '("ACV","AFP","ALF","ALV","APR","APV","AVS","BLC","BRC","BSA","BSP","CC","CCE","CCH","CCR","CMC","CMF","CSA",'+
                  '"CSP","DE","FCF","FFA","FFO","FRA","FRF","FSI","LCE","LCR","OTR","PAF","PRE","PRF","PRO","RCC","RCF","RPR","SSE","TRV")');
end;
