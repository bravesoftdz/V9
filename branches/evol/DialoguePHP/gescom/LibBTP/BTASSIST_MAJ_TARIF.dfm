inherited BTASSIST_MAJ_TARIF: TBTASSIST_MAJ_TARIF
  Left = 365
  Top = 270
  Caption = 'Assistant de mise à jour des bases tarifaires articles'
  PixelsPerInch = 96
  TextHeight = 13
  inherited P: TPageControl
    ...
    object TSDEPART: TTabSheet
      ...
      object RBMAJAPA: TRadioButton
        ...
        Width = 205
        Height = 17
        Caption = 'Mise à jour des prix d'#39'achat'
        TabOrder = 0
      ...
      object RBMAJPV: TRadioButton
        ...
        Width = 205
        Height = 17
        Caption = 'Mise à jour des prix de vente'
        Checked = True
        TabOrder = 1
        TabStop = True
    ...
    object TSACHAT: TTabSheet
      ...
      object Label1: TLabel
        ...
        Align = alTop
        Alignment = taCenter
        Caption = 'Mise à jour des prix d'#39'achats'
      ...
      object SURPVOK: TCheckBox
        ...
        Width = 273
        Height = 17
        Caption = 'Répercution sur le prix de vente'
        TabOrder = 3
      end
    end
      ...
      object PanelFin: TPanel
        ...
        object TTextFin1: THLabel
          ...
          Caption = 
            ...
            'ement de la  mise à jour des bases tarifaires.'
          WordWrap = True
        end
