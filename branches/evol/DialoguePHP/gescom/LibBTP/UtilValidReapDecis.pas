...
begin
	IF EclatCdeFou then
  begin
    Sort := 'GL_TIERS;GL_ETABLISSEMENT;GL_DEPOT;GL_AFFAIRE;GL_IDENTIFIANTWOL;GL_ARTICLE;';
  ...
  begin
    ...
    RuptArt := 'GL_TIERS;GL_ETABLISSEMENT;GL_DEPOT;GL_ARTICLE;GL_IDENTIFIANTWOL;';
  end;
end;
