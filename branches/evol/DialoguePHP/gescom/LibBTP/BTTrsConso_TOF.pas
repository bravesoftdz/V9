...
begin
  ...
  if not GetAffaireEnteteSt(BCO_AFFAIRE0,BCO_AFFAIRE1,BCO_AFFAIRE2,BCO_AFFAIRE3,BCO_AVENANT,Nil,affaire,bProposition,false,false,true,false,'',false,true,false,EtatAffaire ) then Affaire := '';
