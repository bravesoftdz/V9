...
uses
 ...
 cStTexteErreurEnr                     = 'Erreur sur lors de l''enregistrement de la ligne courante ! ' + #13#10 + 'valeur :';
 ...
 cStTexteDebitEtCreditNull             = 'Le debit et le crédit ne peuvent être nulls';
 ...
 cStTexteTransfertReussie              = 'Transfert réussie';
 ...
 type
  ...
  TTypeContexte       = ( TModeGuide, TModeAuto, TModeSaisie );
