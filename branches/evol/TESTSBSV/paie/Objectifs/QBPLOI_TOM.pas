...
Uses Classes,Sysutils,HEnt1,UTob,HDB,HTB97,HMsgBox,
     UTOM,HCtrls,
     {$IFNDEF EAGLCLIENT} db,DBCtrls, {$else} UtileAGL, {$ENDIF}
     UGraph;
...
uses {$IFNDEF EAGLCLIENT} FE_MAIn,Fiche,
     {$IFNDEF DBXPRESS}dbtables{BDE},{$ELSE}uDbxDataSet,{$ENDIF}
     {$else} eFiche, MainEagl, {$ENDIF}
     QUFGBPLOI_TOF,SynScriptBP,UUtil,BPEclatement,
     BPBasic,BPFctSession,BPUtil;
