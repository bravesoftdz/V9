...
begin
  ...
  if EnHt then
  begin
    Ratio := TOBP.GetDouble('GPT_TOTALHTDEV') / TOBPiece.geTDouble('GP_TOTALHTDEV');  // % du montant global
  end else
  begin
    Ratio := TOBP.GetDouble('GPT_TOTALTTCDEV') / TOBPiece.geTDouble('GP_TOTALTTCDEV');
  end;
