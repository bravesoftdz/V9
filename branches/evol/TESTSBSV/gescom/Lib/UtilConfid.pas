...
{$ENDIF}
    ...
    if (V_PGI.DEChamps[TableToNum(NomTable),TobTemp.GetNumChamp(NomChamp)].tipe = 'DOUBLE') then
        begin
        if BTOM=True then
           begin
           if ChDataSet then
        ...
        else if (V_PGI.DEChamps[TableToNum(NomTable),TobTemp.GetNumChamp(NomChamp)].tipe = 'DATE') then
        begin
        if BTOM=True then
           begin
           if ChDataSet then
