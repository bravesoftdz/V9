object FSaisietr: TFSaisietr
  ...
  object DockBottom: TDock97
    ...
    object Outils: TToolbar97
      ...
      object BModifTva: TToolbarButton97
        ...
        Width = 27
        Height = 24
        Hint = 'Modification des '#233'l'#233'ments de Tva'
        Caption = 'TVA'
        DisplayMode = dmGlyphOnly
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
  ...
  object PFEN: TPanel
    ...
    object PEntete: THPanel
      ...
      object H_CONTREPARTIEGEN: THLabel
        ...
        Caption = 'Compte '
        Enabled = False
        FocusControl = E_CONTREPARTIEGEN
        Transparent = True
        Visible = False
      end
    ...
    object BDernPieces: THBitBtn
      ...
      Width = 28
      Height = 27
      Hint = 'Liste des derni'#232'res pi'#232'ces'
      Caption = 'Dern'
      Enabled = False
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
  ...
  object HLigne: THMsgBox
    ...
    Mess.Strings = (
      ...
      '16;?caption?;Attention : ce compte est ferm'#233'.;E;O;O;O;'
        ...
        '30;?caption?;Attention : ce compte est ferm'#233'. Vous ne pouvez plu' +
        's l'#39'utiliser en saisie.;E;O;O;O;'
      
        '31;?caption?;Vous n'#39'avez pas saisi de compte de banque. Confirme' +
        'z-vous l'#39'enregistrement ?;Q;YN;N;N;'
      ' ')
    Left = 553
    Top = 188
  end
  ...
  object HTitres: THMsgBox
    ...
    Mess.Strings = (
      ...
      'Saisie des '#233'critures d'#39'effet')
    Left = 459
    Top = 188
  end
  ...
  object HDiv: THMsgBox
    ...
    Mess.Strings = (
      ...
      '8;?caption?;Vous devez indiquer un mode de paiement.;W;O;O;O;O;'
        ...
        'ATTENTION! Probl'#232'me fichier. Ressayez ou bien validez votre pi'#232'c' +
        'e.'
      
        'ATTENTION! Probl'#232'me fichier. Veuillez revenir au menu, puis rela' +
        'ncer la fonction'
      'RIB :'
      ...
      'EURO'
        ...
        '24;?caption?;ATTENTION. La parit'#233' est incorrecte. Voulez-vous la' +
