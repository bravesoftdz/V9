object FEcheMPA: TFEcheMPA
  ...
  object HME: THMsgBox
    ...
    Mess.Strings = (
        ...
        '0;Modification d'#39#233'ch'#233'ance;Vous devez renseigner une date valide ' +
        '!;W;O;O;O;'
      
        '1;Modification d'#39#233'ch'#233'ance;La date d'#39#233'ch'#233'ance doit respecter la p' +
