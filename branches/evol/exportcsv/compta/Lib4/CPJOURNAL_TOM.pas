...
begin
  ...
  case Comment of
    ...
    taCreat, taCreatEnSerie, taCreatOne:
      begin
        if (not JaiLeDroitConcept(TConcept(ccJalCreat), true)) then
          exit;
        if lStAction='' then
    ...
    taModif, taModifEnSerie:
      begin
        if (not JaiLeDroitConcept(TConcept(ccJalModif), true)) then
          exit;
        if lStAction='' then
...
begin
  if (JaiLeDroitConcept(TConcept(ccJalCreat), true)) then
