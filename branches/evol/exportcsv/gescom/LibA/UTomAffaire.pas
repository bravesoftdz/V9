...
type
  ...
  TOM_Affaire = class (TOM)
    ...
    procedure AjouteChampsClientFac(OneTOB: TOB; ListSqlAFF: string;
      WithData: Boolean);
    procedure AjouteAdressesInt(OneTOB: TOB; var ListNomAdrInt,ListSqlAFF: string;
      WithData: Boolean);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        StCleDuplic := G_CodeAffaire.Text;
        QQ:=OPENSQL('SELECT * From AFFAIRE WHERE AFF_AFFAIRE="'+StCleDuplic+'"',True);
...
//        SetField ('AFF_DATEFIN', GetField ('AFF_DATERESIL') ) ;
  ...
  begin
    ...
    if VH_GC.GCIfDefCEGID then // Spécif CEGID  déplacé ici  le 14/11/02 gm
      OnUpdateCegid;
