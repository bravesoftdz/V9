...
uses {$IFNDEF AGL570}PGIEnv, {$ENDIF}dicoBTP, affaireutil, utofafactivitemul, utofaftabbordole, hmsgbox,
     Paramsoc, utilGa;
...
begin
     Result := JaiLeDroitConcept (ccOLE, FALSE);
...
begin
     ...
     iTableIndex := PrefixeToNum (TableToPrefixe ('TIERS'));
     for i := 1 to High (V_PGI.DEChamps [iTableIndex]) do
     begin
          strNom := V_PGI.DEChamps [iTableIndex, i]. Nom;
          ...
          begin
               ...
               T2.AddChampSupValeur ('DH_LIBELLE', V_PGI.DEChamps [iTableIndex, i].Libelle);
          end;
     end;

     // Table affaire
     T1          := TOB.Create ('Table ' + TraduitGA('Affaire'), theTobDico, -1); //$$$JP 28/01/03 modif nom tob
     iTableIndex := PrefixeToNum (TableToPrefixe ('AFFAIRE'));
     for i := 1 to High (V_PGI.DEChamps [iTableIndex]) do
     begin
          strNom := V_PGI.DEChamps [iTableIndex, i]. Nom;
          T2 := TOB.Create ('nom champ', T1, -1);
     ...
     iTableIndex := PrefixeToNum (TableToPrefixe ('CONTACT'));
     for i := 1 to High (V_PGI.DEChamps [iTableIndex]) do
     begin
          strNom := V_PGI.DEChamps [iTableIndex, i]. Nom;
          ...
          begin
               T2 := TOB.Create ('nom champ', T1, -1);
               T2.AddChampSupValeur ('DH_NOMCHAMP', V_PGI.DEChamps [iTableIndex, i]. Nom);
               T2.AddChampSupValeur ('DH_LIBELLE', V_PGI.DEChamps [iTableIndex, i].Libelle);
          end;
     end;
     ...
     iTableIndex := PrefixeToNum (TableToPrefixe ('PIECE'));
     for i := 1 to High (V_PGI.DEChamps [iTableIndex]) do
     begin
          strNom := V_PGI.DEChamps [iTableIndex, i]. Nom;
     ...
     iTableIndex := PrefixeToNum (TableToPrefixe ('LIGNE'));
     for i := 1 to High (V_PGI.DEChamps [iTableIndex]) do
     begin
          strNom := V_PGI.DEChamps [iTableIndex, i]. Nom;
     ...
     iTableIndex := PrefixeToNum (TableToPrefixe ('FACTAFF'));
     for i := 1 to High (V_PGI.DEChamps [iTableIndex]) do
     begin
          strNom := V_PGI.DEChamps [iTableIndex, i]. Nom;
     ...
     iTableIndex := PrefixeToNum (TableToPrefixe ('ANNUAIRE'));
     for i := 1 to High (V_PGI.DEChamps [iTableIndex]) do
     begin
          strNom := V_PGI.DEChamps [iTableIndex, i]. Nom;
     ...
     iTableIndex := PrefixeToNum (TableToPrefixe ('DPFISCAL'));
     for i := 1 to High (V_PGI.DEChamps [iTableIndex]) do
     begin
          strNom := V_PGI.DEChamps [iTableIndex, i]. Nom;
     ...
     iTableIndex := PrefixeToNum (TableToPrefixe ('DPSOCIAL'));
     for i := 1 to High (V_PGI.DEChamps [iTableIndex]) do
     begin
          strNom := V_PGI.DEChamps [iTableIndex, i]. Nom;
     ...
     iTableIndex := PrefixeToNum (TableToPrefixe ('DPECO'));
     for i := 1 to High (V_PGI.DEChamps [iTableIndex]) do
     begin
          strNom := V_PGI.DEChamps [iTableIndex, i]. Nom;
