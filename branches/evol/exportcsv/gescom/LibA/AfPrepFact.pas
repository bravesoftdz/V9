...
uses FactureBTP,FactOuvrage,CalcOlegenericBtp,FactTimbres,wCommuns;
//
...
//---
    CalculFacture(TOBAffaire,TOBPiece_OK,nil,nil,TobOuvrages ,TOBOuvragesP,TOBBases,TOBBasesL,TOBTiers,TOBArticles,TobPorcs,Nil,Nil,DEV);
//    RecalculeSousTotaux;
...
//  GestionDuVisa;
  GestionDuVisa(TobPiece_ok);
   ...
   GereEcheancesGC(TOBPiece_OK,TOBTiers,TOBEches,NIL,Nil,nil,taCreat,DEV,False);
...
for zz:=0  to Tobpiece_ok.Detail.count-1 do
   ...
   PassationComptable(TOBPiece_OK, TobOuvrages,TOBOuvragesP,TOBBases,TOBBasesL, TOBEches, nil,nil,TOBTiers, TOBArticles, TOBCpta, Nil, TOBPorcs, TOBPieceRG, Nil, nil,nil,nil,DEV, OldEcr, OldStk, True);
   LibereParamTimbres;
...
//      LoadTobVarQte(Nil,TobVarQte_ACT,'ACT');
  ...
  if (GenFac.zcomaffsup <> '') then     //Commentaire Affaire
    ...
    Begin
        ...
        CalculFacture(TOBAffaire,TOBPiece,nil,nil,TobOuvrages ,TOBOuvragesP,TOBBases,TOBBasesL,TOBTiers,TOBArticles,TobPorcs,Nil,Nil,DEV);
