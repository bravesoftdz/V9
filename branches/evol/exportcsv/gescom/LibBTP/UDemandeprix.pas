...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          Arecalc := true;
          if not MiseAjoutLigneDoc (TOBPiece,TOBArticleDemPrix.detail[Indice],TOBPA) then
          begin
  ...
  begin
  	if TraitementRecalculPiece (TOBPiece,True,True) <> TrrOk then V_PGI.IOError := oeUnknown;
  end;
end;
