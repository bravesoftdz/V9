...
uses Grids,
     ...
     UtofBtanalDev,
     TiersUtil,
     UtilTobPiece, DB,Vierge,FactTOB,FactUtil,FactSituations;
...
UpdateCaption(Ecran);
  ...
  begin
    ...
    if BTDuplic.DropdownMenu = nil then BTDuplic.OnClick := BTDuplicationClick;
  end;
...
if (TypePiece <> ''){ and (Length(TypePiece) = 3) } then
  ...
  begin
    ...
    begin
      Caption := 'Rectification de factures via avoir';
    end else
    begin
...
begin
  ...
  if (pos(ecran.name,'BTDEVIS_MUL;BTPIECE_MUL;BTPIECENEG_MUL;BTDEVISNEG_MUL;BTSITPROV_MUL') = 0) then exit;
  ...
  begin
    ...
    begin
      ...
      exit;
   	...
   	AppelDupliquePiece ([thechaine,ClePiece[5],ClePiece[6]],3);
  end;
...
var OneTOB,TobPieces,TOBPIECE : TOB;
		i : Integer;
begin
