...
const
  ...
  TexteMessage: array[1..51] of string  = (
...
uses ctiAlerte,factcomm,LicUtil,BTSIGNATURE_TOF,Menus;
...
begin
  ...
  //
  TobAdrInt.PutValue('ADR_GARDIEN', GetControlText('TGARDIEN'));
  TobAdrInt.PutValue('ADR_CODEENTREE1', GetControlText('TCODEENTREE1'));
  TobAdrInt.PutValue('ADR_CODEENTREE2', GetControlText('TCODEENTREE2'));
...
//  Telephone.enabled := false;
  ...
  //
  SetControlText('TGARDIEN',      TobAdrInt.GetValue('ADR_GARDIEN' ));
  SetControlText('TCODEENTREE1',   TobAdrInt.GetValue('ADR_CODEENTREE1' ));
  SetControlText('TCODEENTREE2',   TobAdrInt.GetValue('ADR_CODEENTREE2' ));
...
Begin
  ...
  Req := Req + 'ADR_GARDIEN, ADR_CODEENTREE1,ADR_CODEENTREE2, ';
...
Begin
  ...
  Begin
    ...
    SetControlText('TGARDIEN',      GetValue('ADR_GARDIEN' ));
    SetControlText('TCODEENTREE1',  GetValue('ADR_CODEENTREE1' ));
    SetControlText('TCODEENTREE2',  GetValue('ADR_CODEENTREE2' ));
...
Begin
  ...
  Begin
    ...
    //
    SetControltext('TBATIMENT', GetValue('C_BATIMENT'));
    SetControltext('TETAGE', GetValue('C_ETAGE'));
    SetControltext('TESCALIER', GetValue('C_ESCALIER'));
    SetControltext('TPORTE', GetValue('C_PORTE'));
  End;
...
begin
  ...
  DefinieInfoSupp; // ajoute des zones Gardien, etc..
...
begin
  ...
  if not IsValidDate(GetControlText('AFF_DATESOUHAIT')) then exit;
