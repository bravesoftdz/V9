...
begin
	IF EclatCdeFou then
  begin
    Sort := 'GL_TIERS;GL_ETABLISSEMENT;GL_DEPOT;GL_AFFAIRE;GL_IDENTIFIANTWOL;GL_ARTICLE;GL_LIBELLE';
    RuptDoc := 'GL_TIERS;GL_ETABLISSEMENT;GL_DEPOT;GL_AFFAIRE;GL_IDENTIFIANTWOL;';
    RuptArt := Sort;
  end else
  begin
    Sort := 'GL_TIERS;GL_ETABLISSEMENT;GL_DEPOT;GL_ARTICLE;GL_IDENTIFIANTWOL;GL_AFFAIRE';
    RuptDoc := 'GL_TIERS;GL_ETABLISSEMENT;';
    RuptArt := 'GL_TIERS;GL_ETABLISSEMENT;GL_DEPOT;GL_ARTICLE;GL_LIBELLE;GL_IDENTIFIANTWOL;';
  end;
end;
