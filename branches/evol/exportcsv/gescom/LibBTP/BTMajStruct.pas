...
implementation
uses ChangeVersions,Paramsoc,uPGFnWorkRh,PGInitRemDSN;
{$R *.DFM}
...
begin
  ...
  else if NomTable = 'BTPARAMPLANNING' then
  begin
    if VersionBaseDest < '998.ZZL' then
    begin
      ExecuteSql ('UPDATE HRPARAMPLANNING SET HPP_FAMMATGERE="" WHERE HPP_FAMMATGERE IS NULL');
    end;
  end
...
begin
  ...
  begin
    ...
    begin
      // dans le cas ou nouveau menu on positionne celui ci comme non visible.
