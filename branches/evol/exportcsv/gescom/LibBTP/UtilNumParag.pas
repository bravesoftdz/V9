...
begin
  TOBCompteur.AddChampSupValeur('PN1',0);
  TOBCompteur.AddChampSupValeur('PN2',0);
  TOBCompteur.AddChampSupValeur('PN3',0);
  TOBCompteur.AddChampSupValeur('PN4',0);
  TOBCompteur.AddChampSupValeur('PN5',0);
  TOBCompteur.AddChampSupValeur('PN6',0);
  TOBCompteur.AddChampSupValeur('PN7',0);
  TOBCompteur.AddChampSupValeur('PN8',0);
  TOBCompteur.AddChampSupValeur('PN9',0);
  TOBCompteur.AddChampSupValeur('PN10',0);
end;
...
begin
  ...
  if NivP = -1 then exit;
  TOBCompteur.SetInteger('PN'+InttoStr(NivP),TOBCompteur.getInteger('PN'+InttoStr(NivP))+1);
...
begin
  ...
  if TOBcompteur.GetInteger('PN2')<>0 then Result:= Result +'.'+ TOBcompteur.GetString('PN2');
  if TOBcompteur.GetInteger('PN3')<>0 then Result:= Result +'.'+ TOBcompteur.GetString('PN3');
  if TOBcompteur.GetInteger('PN4')<>0 then Result:= Result +'.'+ TOBcompteur.GetString('PN4');
  if TOBcompteur.GetInteger('PN5')<>0 then Result:= Result +'.'+ TOBcompteur.GetString('PN5');
  if TOBcompteur.GetInteger('PN6')<>0 then Result:= Result +'.'+ TOBcompteur.GetString('PN6');
  if TOBcompteur.GetInteger('PN7')<>0 then Result:= Result +'.'+ TOBcompteur.GetString('PN7');
  if TOBcompteur.GetInteger('PN8')<>0 then Result:= Result +'.'+ TOBcompteur.GetString('PN8');
  if TOBcompteur.GetInteger('PN9')<>0 then Result:= Result +'.'+ TOBcompteur.GetString('PN9');
  if TOBcompteur.GetInteger('PN10')<>0 then Result:= Result +'.'+ TOBcompteur.GetString('PN10');
end;
...
begin
  ...
  if Niveau = 0 then TOBcompteur.SetInteger('PN1',0);
  if Niveau < 2 then TOBcompteur.SetInteger('PN2',0);
  if Niveau < 3 then TOBcompteur.SetInteger('PN3',0);
  if Niveau < 4 then TOBcompteur.SetInteger('PN4',0);
  if Niveau < 5 then TOBcompteur.SetInteger('PN5',0);
  if Niveau < 6 then TOBcompteur.SetInteger('PN6',0);
  if Niveau < 7 then TOBcompteur.SetInteger('PN7',0);
  if Niveau < 8 then TOBcompteur.SetInteger('PN8',0);
  if Niveau < 9 then TOBcompteur.SetInteger('PN9',0);
  if Niveau < 10 then TOBcompteur.SetInteger('PN10',0);
end;
...
begin
  ...
  begin
    ...
    begin
      if Niveau = 0 then MemoriseInfo(TOBL);
    end;
