  ...
  begin
    ...
    TRY
      ...
      begin
        ...
        Result := CreatePieceFromTOB (TOBPiece,nil,nil);
        if Result then
        begin
...
begin
  ...
  begin
    ...
    begin
      ...
      QQ := OpenSql ('SELECT GL_QTEFACT, GL_PUHTDEV FROM LIGNE WHERE GL_AFFAIRE="'+CodeAffaire+'" AND GL_IDSPIGAO="'+workItem.Id+'"',true,-1,'',true);
      if Not QQ.Eof then
      begin
