...
// 284209 : AFLanceFicheRegulFacture;
   ...
   304180 : AGLLanceFiche('BTP','BTDEVISINT_MUL','GP_NATUREPIECEG=DAP;GP_VENTEACHAT=VEN','','MODIFICATION;STATUT=APP');   //Modif Avoirs
	 ...
	 304210 : AGLLanceFiche('BTP','BTMULEDIBI','','','ETAT=AFF;STATUT=APP');
...
//   32207 : GCLanceFiche_MouvStkExContr('GC','GCMOUVSTKEXCONTR','','','');  // Mouvements exceptionnels contremarque
   ...
   32406 : AGLLanceFiche('BTP','BTINTEGREFICTPI','','','');
    {begin
      ...
      V_Pgi.ZoomOle := True ;
      try
        AGLLanceFiche('BTP','BTINTEGREFICTPI','','','');
      Finally
        V_Pgi.ZoomOle := OldValue ;
      end;
     end;}
...
Cegid,False,False)};
   ...
   60208 : GCLanceFiche_Confidentialite( 'YY','YYCONFIDENTIALITE','','','26;27;60;92;111;145;146;147;148;149;150;160;283;284;285;304;319;320;321;322;323;325;327;328;329');
   // --
...
{$ENDIF}
    ...
    145414 : AGLLanceFiche('BTP','BTVALSITPROV_MUL','','','') ;
    ...
    145428 : AGLLanceFiche('BTP','BTRECTSIT_MUL','GP_NATUREPIECEG=FBT;GP_VENTEACHAT=VEN','','MODIFICATION;STATUT=AFF');   //Modif Factures
...
//    145810 : AGLLanceFiche('GC','GCTRANSPIECE_MUL','GP_NATUREPIECEG=BLC;GP_VIVANTE=X','','ALV') ;  // Retour chantier
    ...
    283210 : AGLLanceFiche('BTP','BTPIECE_MUL','GP_NATUREPIECEG=CBT','','CONSULTATION') ;
...
//  147211 : AGLLanceFiche('BTP','BTDEVIS_MUL_S1','GP_NATUREPIECEG=DBT;GP_VENTEACHAT=VEN;ZEACTION=PLANNIFICATION;AFF_ETATAFFAIRE=ACP;AFF_PREPARE=-','','MODIFICATION') ;   //devis
    ...
    147711 : BEGIN AppelLienVP;RetourForce := True; END;
    147712 : BEGIN AppelVP; RetourForce := True;END;

    147811 :BEGIN
              OldValue := V_Pgi.ZoomOle ;
              V_Pgi.ZoomOle := True ;
              try
                OpenPlanningBtp (TmPcPlanCharge) ;
              finally
                V_Pgi.ZoomOle := OldValue ;
              end;
            END;
    147812 :BEGIN
              ...
              V_Pgi.ZoomOle := True ;
              try
                OpenPlanningBtp (TmcPlanCharNat) ;
              finally
                V_Pgi.ZoomOle := OldValue ;
              end;
            END;
...
begin
	FMenuG.SetModules([145,325,327,283,328,146,150,147,92, 329, 284,304,323,149,160,148,60],[24,77,21,74,72,121,124,41,77,99,127,73,9,110,69,99,34,49]) ;
end;
...
V_PGI.NumBuild:='000.101';
V_PGI.CodeProduit:='034' ;
V_PGI.DateVersion:=EncodeDate(2016,02,01);
