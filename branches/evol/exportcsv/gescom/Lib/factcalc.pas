...
Procedure CalculFacture ( TOBAffaire,TOBPiece,TOBPieceTrait,TOBSSTRAIT,TOBouvrages,TOBouvragesP,TOBBases,TOBBasesL,TOBTiers,TOBArticles,TOBPorcs,TOBPieceRG,TOBBasesRG : TOB ; DEV : RDEVISE ;SaisieTypeAvanc : boolean=false; Action: TActionFiche=TaModif; ModifAvanc : boolean=false; LigneACalcule : integer=-1; FromGenfac : boolean=false; FromZero : boolean=false) ;
// --
...
procedure CalculeLaLigne (TOBAffaire,TOBPiece,TOBPieceTrait,TOBSSTRAIT,TOBOUvrages,TOBOUvragesP,TOBBases,TOBBasesL,TOBTiers,TOBArticles,TOBPOrcs,TOBPieceRG,TOBBasesRG,TOBL : TOB;DEV : Rdevise; NbDec : integer; saisieAvanc : boolean =false; ModifAvanc : boolean=false; FF : Tform = nil);
{$IFDEF BTP}
...
if TOBT<>Nil then
BEGIN
   if (FamilleTaxe = 'INT') and (venteAchat='ACH') then
   begin
     Taux := 0;
...
//      TOBPiece.PutValue('MONTANTSIT',TOBPiece.GetValue('MONTANTSIT')+TOBL.GetValue('MONTANTSIT'));
  ...
  //FV1 : Qd on arrive des appel d'offre TOBPIECE n'est pas renseigné
    ...
    recalculeRGloc (TOBTiers,TOBPiece,TOBPieceTrait,TOBBasesL,TOBPieceRG,TOBBasesRG,TOBporcs,DEV,FromGenFac);
  end else
  begin
  	DefiniPieceTrait (TOBBases,TOBPiece,TOBAFFaire,TOBPieceTrait,TOBSSTrait,DEV);
  end;
...
begin
  ...
  CalculFacture (TOBAffaire,TOBPiece,TOBpiecetrait,TOBSSTRAIT,TOBOUvrages,TOBOuvragesP,TOBBases,TOBBAsesL,TOBTiers,TOBArticles,TOBPOrcs,TOBPieceRG,TOBBasesRG,DEV,saisieAvanc,TaModif,ModifAvanc,LaLIgne);
