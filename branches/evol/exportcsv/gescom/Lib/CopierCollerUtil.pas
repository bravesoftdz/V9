...
{$ENDIF}
     HRichOLE,UTOFBTMEMORISATION,CBPPath,UtilNumParag;
...
implementation
uses facture,FactCalc,PiecesRecalculs,FactDOmaines,UtilArticle,FactureBtp,factDetOuvrage;
{ TCopieColle }
...
begin
  ...
  //Why this Mother fucker area not initizalize ????
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if TOBOO <> nil then CopieDonneeOuvrage (TOBLien,TOBOO);
        end;
      end;
    end;
