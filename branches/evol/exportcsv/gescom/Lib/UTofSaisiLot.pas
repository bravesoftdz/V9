...
Function TOF_SaisiLot.QuelChampLigne ( iTableLigne : integer ; NomChamp : String ) : integer ;
Var i : integer ;
begin
Result:=-1 ;
for i:=1 to High(V_PGI.Dechamps[iTableLigne]) do
    if V_PGI.DEChamps[iTableLigne,i].Nom=NomChamp then
       begin
       Result:=i ;
       Break ;
       end ;
