    ...
    BEGIN
      ...
      BEGIN
        ...
        begin
          ...
          if TOBN.FieldExists('BOP_COEFCONVQTEVTE') then COefUSUV := TOBN.getvalue('BOP_COEFCONVQTEVTE');
  ...
  trsDocument :
    BEGIN
      ...
      BEGIN
        if TOBN<>Nil then
        begin
          Coefuaus := TOBN.getvalue('BOP_COEFCONVQTE');
          if TOBN.FieldExists('BOP_COEFCONVQTEVTE') then COefUSUV := TOBN.getvalue('BOP_COEFCONVQTEVTE');
          //
          if CoefuaUs <> 0 then
          begin
...
begin
  ...
  end else if (cledoc.NaturePiece='CBT') then
  begin
