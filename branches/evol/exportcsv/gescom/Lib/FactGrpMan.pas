...
if Not PassationComptable(TOBGenere,TOBOuvrage ,TOBOuvragesP,TOBBases,TOBBasesL,TOBEches,nil,nil,TOBTiers,TOBArticles,TOBCpta,TOBAcomptes,TOBPorcs,TOBPIECERG,TOBBasesRG,TOBanaP,TOBanaS,nil,DEV,OldEcr,OldStk,True)
...
CalculFacture(nil,TOBGenere,nil,nil,TOBOuvrage,TOBOuvragesP,TOBBases,TOBBasesL,TOBTiers,TOBArticles,TOBPorcs,TOBPieceRG,TOBBasesRG,DEV) ;
{$IFDEF BTP}
