...
{V500_002_TS_28/10/2003}
  ...
  function CreatePieceFromTob(TobData: Tob; FuncBeforeValidePiece: TFuncGerePiece = nil
                                          ; FuncAfterValidePiece: TFuncGerePiece = nil; CodeEtat : String=''): Boolean;
...
{V500_002_TS_28/10/2003 Fin}
            ...
            begin
              ...
              //FV1 :?? je comprends pas pourquoi on a ce test en V9 !!!!!
              ...
              begin
                ...
                if not TobData.Detail[i].FieldExists('REFARTSAISIE') then
                ...
                begin
                  TobLigne.PutValue('GL_DPA', TobData.Detail[i].GetValue('DPA'));
                  TobLigne.PutValue('GL_DPR', TobData.Detail[i].GetValue('DPR'));
                  ...
                  TobLigne.PutValue('GL_PUHT',      TobData.Detail[i].GetValue('PUHT'));
                end;
  {V500_002_TS_28/10/2003 Début}
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  begin
                    MtCautionconsomme := Arrondi(TobData.GetDouble('DEJAFACTURE')*1.2*0.05,V_PGI.okdecV);
...
//              GetVisaInfoEtPositionne(V.TobPiece, V.TobTiers);
            ...
            begin
              ...
              // ---
              CalculFacture(V.TobAffaire ,V.TobPiece, V.TOBPieceTrait,V.TOBSSTRAIT, V.TOBOuvrage,V.TOBOuvragesP, V.TobBases, V.TobBasesL, V.TobTiers, V.TobArticles, V.TobPorcs, V.TOBPieceRG, V.TOBBasesRG, V.Dev,False,taCreat);
...
GestionConso := TGestionConso.create;
  ...
  begin
    if not PassationComptable(TobPiece,TOBOuvrage ,TOBOuvragesP, TobBases, TOBBasesL,TobEches, TOBpieceTrait,TOBAffaireInterv,TobTiers, TobArticles, TobCpta, TobAcomptes
                             , TobPorcs, TOBPieceRG, TOBBasesRG, TOBanaP,TOBAnaS,nil,Dev, OldEcr, OldStk, True) then
...
//    ValideLesSeries;
  ...
  if V_PGI.IoError = oeOk then
  begin
    if pos(TOBPiece.GetValue ('GP_NATUREPIECEG'),'LBT;BFC')>0  then
    begin
      for i := 0 to TOBPiece.Detail.Count - 1 do
      begin
