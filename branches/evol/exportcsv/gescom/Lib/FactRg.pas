...
procedure CalculBaseRG (TOBTiers,TOBPiece,TOBPieceTrait,TOBBasesL,TOBPIeceRG,TOBBasesRg,TOBS, TOBPorcs: TOB; R_Valeurs : R_CPercent;DEV:Rdevise;GenerationFac:boolean=false);
...
BEGIN
  if TOBPIECERG = nil then exit;
  if (TOBPieceRG.detail.count > 1) and (IsRGSimple(TOBPieceRG)) then
  begin
