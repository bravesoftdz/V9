...
{$ENDIF}
     HCtrls, FactTOB, SysUtils, EntGC , UentCommun;
...
begin
  ...
  if GetInfoParSouche(SoucheG, 'SH_NUMMOISPIECE') = 'X' then
  begin
...
begin
  ...
  if GetInfoParSouche(SoucheG, 'SH_NUMMOISPIECE') = 'X' then Ok_Cpt := True else Ok_Cpt := False;
