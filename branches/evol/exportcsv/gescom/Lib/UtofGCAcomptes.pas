...
begin
  ...
  begin
    ...
    fCurrentOnglet.TobAComptes.detail[Indice].SetDouble ('MONTANTDISPO',fCurrentOnglet.TobAComptes.detail[Indice].Getdouble('GAC_MONTANTDEV'));
    if (Bprorata <> nil) and (Bprorata.Checked) then
    begin
...
begin
  ...
  TRY
    ...
    begin
      if TOBPiedP.detail[II].getValue('GPT_FRAISREPARTIS')<>'X' then
      begin
