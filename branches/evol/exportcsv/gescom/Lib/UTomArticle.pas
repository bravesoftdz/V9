...
Begin
  ...
  if BACTUPRIX <> nil then BACTUPRIX.OnClick   := DPRAUTO_OnClick;
  ...
  begin
{
    ...
    SQL := 'Select GCA_TIERS, GCA_REFERENCE, T1.T_LIBELLE, GCA_PRIXBASE from CATALOGU '
    ...
    begin
      ...
      begin
        ...
        TOBFournFille.PutValue('GCA_PRIXBASE', QFourn.Findfield('GCA_PRIXBASE').AsFloat);
        inc(NbCatalogue);
        QFourn.next;
      end;
    end;
