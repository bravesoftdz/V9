...
begin
  ...
  begin
    ...
    MiseAjourDispoInv(TL,FPrix,RecalcPmap);
    //
  end;
  ...
  begin
    ...
    CalculFacture(nil, Tob_Piece, nil,nil,nil,nil,Tob_PiedBase,Tob_LigneBase, Tob_Tiers, Tob_Article, nil,nil,nil, DEV) ;
