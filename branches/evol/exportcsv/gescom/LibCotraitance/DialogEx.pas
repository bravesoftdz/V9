...
Type
  TMsgDlgTEx = (mtxWarning, mtxError, mtxInformation, mtxConfirmation, mtxCustom,
    mtxPerso);
...
Function ExMessageDlg(Const Msg: String; DlgType: TMsgDlgTEx;
...
Function ExMessageDlgBox(Const Msg: String; DlgType: TMsgDlgTEx;
  Buttons: TMsgDlgButtonsEx; HelpCtx: Longint; Const DefBtn: TMsgDlgBtnEx =
...
Var
  CaptionsEx        : Array[TMsgDlgTEx] Of Pointer = (@SMsgDlgWarning,
    @SMsgDlgError,
    @SMsgDlgInformation, @SMsgDlgConfirm, Nil, @SMsgPerso);

  IconIDsEx         : Array[TMsgDlgTEx] Of PChar = (IDI_EXCLAMATION,
    IDI_HAND,
...
Function CreateMessageDialogEx(Const Msg: String; DlgType: TMsgDlgTEx;
...
Begin
  ...
  With Result Do
    Begin
      ...
      If (DlgType <> mtxCustom) And (DlgType <> mtxPerso) Then
        Caption := LoadResString(CaptionsEx[DlgType]) Else
        If (DlgType = mtxPerso) And (CustCaption <> '') Then
...
Function MessageDlgPosHelpEx(Const Msg: String; DlgType: TMsgDlgTEx;
...
Function ExMessageDlgBox(Const Msg: String;
  DlgType           : TMsgDlgTEx;
  Buttons           : TMsgDlgButtonsEx;
  HelpCtx           : Longint;
  Const DefBtn      : TMsgDlgBtnEx;
