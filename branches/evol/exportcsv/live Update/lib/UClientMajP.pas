...
uses
  ...
  FileCtrl, Spin, ImgList,UControleUAC, Mask, UEncryptage, UbrowseRepert,Uregistry,URVRunAS;
...
procedure TFlanceurMajLse.FormClose(Sender: TObject; var Action: TCloseAction);
begin
	TrunAs.Free;
end;
