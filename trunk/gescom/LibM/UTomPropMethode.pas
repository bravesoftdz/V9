...
const
  ...
  TexteMessage: array[1..3] of string = (
    ...
    {3}'La date de fin doit être supérieure à la date de début'
    );
...
begin
  ...
  begin
    ...
    begin
      //Ces 2 lignes permettent de d'afficher le message : voulez-vous enregistrer... quand on sélectionne une méthode
