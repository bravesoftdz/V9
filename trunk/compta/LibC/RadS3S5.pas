...
uses
  ...
  MailOL, HFLabel, UiUtil, Ent1, uDbxDataSet;
...
type
  ...
  private
    ...
    procedure EnvoyerLeFichier(Fichier, MailTo, subject: string; MailText: HTStrings; importance, EnvoiAuto: boolean);
...
begin
  ...
  EnvoyerLeFichier(Fichier, FEMail.Text, MsgDiv.Mess[11], HTStringList(FCorpsMail.Lines), FHigh.Checked, FMail.Checked);
  FlashLblInfo.caption := '';
  MajRadEtat(1);
end;
...
procedure TFRevDist.EnvoyerLeFichier(Fichier, MailTo, subject: string; MailText: HTStrings; importance, EnvoiAuto: boolean);
var
  high: integer;
begin
